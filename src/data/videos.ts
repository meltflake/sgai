...
export const videos: VideoItem[] = [
  ...
  },
  {
    ...
    titleJa: 'シンガポール、データセンター向けクラウドサービスライセンス新規制を推進',
    titleKo: '싱가포르, 데이터센터 클라우드 서비스 허가 신규 규칙 추진',
    speaker: 'CNA',
    ...
    date: '2026-09-09',
    duration: '03:05',
    summary: '新加坡推进新的数据中心许可规则,要求加强安全措施和应急准备。超过一半的数据中心将受新规影响。',
    summaryEn:
      "Singapore is introducing new licensing rules for data centres and cloud services to enhance security. Over half of the nation's data centres will be subject to the new regulations.",
    summaryJa:
      'シンガポールは新しいデータセンター許可規則を推進しており、セキュリティー対策と緊急対応準備の強化が求められています。データセンターの過半が新規則の影響を受けることになります。',
    summaryKo:
      '싱가포르는 새로운 데이터센터 허가 규칙을 추진하고 있으며 보안 조치 강화와 긴급 대비를 요구하고 있습니다. 절반을 넘는 데이터센터가 새 규칙의 영향을 받을 것입니다.',
    topic: 'AI 治理与监管',
    topicEn: 'AI Governance & Regulation',
    topicJa: 'AI ガバナンスと規制',
    topicKo: 'AI 거버넌스와 규제',
    youtubeUrl: 'https://www.youtube.com/watch?v=le1IZq60vVM',
    channel: 'CNA',
    addedAt: '2026-09-10',
  },
  {
    id: 'v094',
    title: '新加坡有序扩展数据中心容量',
    titleEn: "Tan Kiat How on Singapore's disciplined data centre growth",
    titleJa: 'シンガポール、データセンター容量を秩序立って拡張',
    titleKo: '싱가포르, 데이터센터 용량을 질서 있게 확대',
    ...
    date: '2026-09-09',
    duration: '02:02',
    summary: '新加坡将有序增长数据中心容量，强调虽然AI对未来经济至关重要，但不会为扩展而扩展。',
    summaryEn:
      "Tan Kiat How explains Singapore will grow data centre capacity in a disciplined way, emphasizing that while AI is important, expansion won't be pursued for its own sake.",
    summaryJa:
      'シンガポールはデータセンター容量を秩序立って増加させるとしながら、AIが将来の経済に不可欠であるものの、拡張のための拡張は行わないと強調しています。',
    summaryKo:
      '싱가포르는 데이터센터 용량을 질서 있게 증가시킬 것이며, AI가 미래 경제에 매우 중요하다는 점을 인정하면서도 단순히 확대하기 위해 확대하지는 않을 것이라고 강조했습니다.',
    whyItMatters: '国会问答首次挑明数据中心扩张的边界逻辑，土地与能源约束优先于追赶全球集群竞赛',
    whyItMattersEn:
      'Parliament Q&A for the first time clarifies the boundary logic of data centre expansion, prioritizing land and energy constraints over competing in the global cluster race',
    whyItMattersJa:
      '国会での質疑応答がデータセンター拡張の境界ロジックを初めて明確にし、土地とエネルギー制約がグローバルなクラスター競争への追従よりも優先されることが示された',
    whyItMattersKo:
      '국회 문답에서 데이터센터 확장의 경계 논리를 처음 명시했으며, 토지와 에너지 제약이 글로벌 클러스터 경쟁을 추격하는 것을 우선한다',
    topic: 'AI 治理与监管',
    topicEn: 'AI Governance & Regulation',
    topicJa: 'AI ガバナンスと規制',
    topicKo: 'AI 거버넌스와 규제',
    youtubeUrl: 'https://www.youtube.com/watch?v=jB5W_3t_Utw',
    channel: 'The Straits Times',
    addedAt: '2026-09-10',
  },
  {
    id: 'v095',
    title: 'OpenAI 前沿工程师职业探讨',
    titleEn: 'Forward Deployed Engineering with OpenAI',
    titleJa: 'OpenAI、先端エンジニア職のキャリア討論',
    titleKo: 'OpenAI 첨단 엔지니어 커리어 논의',
    ...
    date: '2026-09-09',
    duration: '01:45',
    summary: '探讨前沿部署工程师这一新兴职位的角色特征和所需技能。',
    summaryEn:
      'The meetup explores Forward Deployed Engineering as an emerging role, featuring OpenAI speakers discussing what the role entails and necessary skills.',
    summaryJa: '最先端デプロイメントエンジニアという新興職位の役割特性と必要スキルについて探討しています。',
    summaryKo: '첨단 배포 엔지니어라는 신흥 직책의 역할 특성과 필요한 기술을 논의합니다.',
    whyItMatters: 'AI Singapore 拆解 OpenAI 前沿部署工程师技能画像，本地对这类新兴角色仍无自有定义',
    whyItMattersEn:
      "AI Singapore deconstructs the competency profile of OpenAI's frontier deployment engineers, yet the local market still lacks its own definition for such emerging roles",
    whyItMattersJa:
      'AI Singaporeが、OpenAIの最先端デプロイメント・エンジニアのスキルプロファイルを分析し、シンガポールではこの種の新興職に対してまだ独自の定義がない',
    whyItMattersKo:
      'AI Singapore가 OpenAI의 최첨단 배포 엔지니어 기술 프로필을 분석했으나, 싱가포르에서는 이런 신흥 역할에 대한 자체 정의가 여전히 없다',
    topic: 'AI 人才与教育',
    topicEn: 'AI Talent & Education',
    topicJa: 'AI 人材と教育',
    topicKo: 'AI 인재와 교육',
    youtubeUrl: 'https://www.youtube.com/watch?v=mpGAidoiYIo',
  ...
  },
  {
    id: 'v096',
    title: '主队学院用AI强化警官培训',
    titleEn: 'Home Team Academy enhances officer training with AI tools',
    titleJa: 'ホームチームアカデミーはAIを活用して警察官訓練を強化しています',
    titleKo: '주대 학원이 AI로 경찰관 훈련 강화',
    speaker: 'Home Team Academy',
    speakerTitle: '新加坡主队培训学院',
    speakerTitleEn: "Singapore's home team training academy",
    speakerTitleJa: 'シンガポール・ホームチーム訓練アカデミー',
    speakerTitleKo: '싱가포르 주대 훈련 학원',
    speakerType: 'government',
    date: '2026-09-08',
    duration: '02:44',
    summary: '主队学院推出AI学习工具和虚拟射击场以强化警官培训。',
    summaryEn:
      'Home Team Academy is introducing AI-powered learning tools and virtual shooting ranges to enhance officer training for complex operations.',
    summaryJa: 'ホームチームアカデミーはAI学習ツールと仮想射撃場を導入し、警察官訓練を強化しました。',
    summaryKo: '주대 학원이 경찰관 훈련을 강화하기 위해 AI 학습 도구와 가상 사격장을 도입했습니다.',
    whyItMatters: '主队学院引入 AI 培训工具和虚拟靶场，显示新加坡 AI 应用已从产业政策延伸至警队等治安一线',
    whyItMattersEn:
      "The Police Academy introduces AI training tools and virtual firing ranges, demonstrating that Singapore's AI applications have extended from industrial policy to front-line law enforcement and public security",
    whyItMattersJa:
      'ホームティーム・アカデミーがAI訓練ツールとバーチャル射撃場を導入し、シンガポールのAI応用が産業政策から警察等の治安最前線へと拡大したことを示している',
    whyItMattersKo:
      '홈팀 아카데미가 AI 교육 도구와 가상 훈련장을 도입했으며, 싱가포르 AI 응용이 산업정책에서 경찰 등 치안 현장까지 확대되고 있음을 보여준다',
    topic: 'AI 人才与教育',
    topicEn: 'AI Talent & Education',
    topicJa: 'AI 人材と教育',
    topicKo: 'AI 인재와 교육',
    youtubeUrl: 'https://www.youtube.com/watch?v=m1deRamGPbI',
    channel: 'CNA',
    addedAt: '2026-09-10',
  },
  {
    ...
    whyItMatters: '500 公斤机器人进驻监狱执勤，新加坡把 AI 试验首次推进到监禁与强制力一线',
    whyItMattersEn:
    ...
    topicJa: 'AI 産業と応用',
    topicKo: 'AI 산업 및 응용',
    youtubeUrl: 'https://www.youtube.com/watch?v=-vdqbrcUDRI',
    channel: 'CNA',
    addedAt: '2026-09-04',
  },
  {
    ...
    summaryJa:
      'シンガポールのホテルは補助金を受けてAIコンシェルジュソリューションを採用でき、日常業務を処理して人手不足を解決できます。',
    summaryKo:
      '싱가포르 호텔은 AI 콘시어지 방안 도입 지원금을 받을 수 있으며, 일상 업무를 처리하여 인력 부족 문제를 해결합니다.',
    whyItMatters: '新加坡用补助换酒店采纳 AI 礼宾解决缺工，这套补贴换技术的路径可能扩散到更多劳动密集型服务业',
    whyItMattersEn:
    ...
    topicJa: 'AI 産業と応用',
    topicKo: 'AI 산업 및 응용',
    youtubeUrl: 'https://www.youtube.com/watch?v=24eLQSN_s7E',
    channel: 'CNA',
    addedAt: '2026-09-04',
  },
  {
    ...
    topicJa: 'AI 産業と応用',
    topicKo: 'AI 산업 및 응용',
    youtubeUrl: 'https://www.youtube.com/watch?v=GqIq7cJkJPg',
    channel: 'The Straits Times',
    addedAt: '2026-09-04',
  },
  {
    id: 'v092',
    title: '东盟AI就绪计划',
    titleEn: 'Building an AI-Ready ASEAN',
    titleJa: 'AI Ready ASEAN計画',
    titleKo: 'AI Ready ASEAN',
    speaker: 'AI Singapore',
    speakerTitle: 'AI 研究与人才培养机构',
    speakerTitleEn: 'AI research and talent-development organisation',
    speakerTitleJa: 'AI 研究と人材育成機関',
    ...
    summaryJa:
      'AI Ready ASEANはMaster Trainersプロジェクトを通じて、ASEAN550万市民にAI知識と応用スキルを教えています。',
    summaryKo:
      'AI Ready ASEAN은 Master Trainers 프로그램을 통해 ASEAN 550만 시민에게 AI 지식 및 응용 기술을 교육합니다.',
    whyItMatters:
      'AI Ready ASEAN 计划 2026 年前培训 550 万人，如今只剩四个月，新加坡执行方 AI Singapore 的完成进度尚未公开',
    whyItMattersEn:
    ...
    topicJa: 'AI 人材と教育',
    topicKo: 'AI 인재와 교육',
    youtubeUrl: 'https://www.youtube.com/watch?v=B1eJ_A1U7og',
    channel: 'AI Singapore',
    addedAt: '2026-09-04',
  },
  {
