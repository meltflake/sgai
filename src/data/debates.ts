...
export const debates: Debate[] = [
  ...
  },
  {
    ...
    topicIds: ['talent-education', 'advanced-manufacturing', 'connectivity', 'finance', 'healthcare'],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    relatedTimelineYears: [],
    relatedPostSlugs: [],
...
: The new artificial intelligence (AI) diffusion rule has not been finalise`,
  ...
  },
  {
    ...
    governmentStanceJa: '大臣声明により理由を詳述される予定',
...
export const MP_PROFILES = [
  ...
  },
  {
    ...
    notablePositionJa: 'デジタル発展大臣、国家 AI 戦略 2.0 主導、データセキュリティと国際協力並行を強調',
    notablePositionEn:
