...
export const debates: Debate[] = [
  {
    id: 'written-answer-23654',
    titleEn: `Implementation of Stay-down Measures for Non-consensual Intimate Images and Sexualised Deepfakes under the Online Safety Commission`,
    title: `针对非自愿私密影像与性化深伪的"限时下架"措施,以及在全球范围内阻断访问的权限`,
    titleKo: `온라인안전위원회 아래 비동의 친밀 이미지와 성적 딥페이크에 대한 재게시 방지(stay-down) 조치 시행`,
    titleJa: `オンライン安全委員会の下での非同意親密画像・性的ディープフェイクに対する再アップロード防止(stay-down)措置の実施`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Miss Rachel Ong', 'Mrs Josephine Teo'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    ...
    summary: `王诗尼女士(Rachel Ong)书面质询数字发展与信息部:(a) 被在线安全委员会(OSC)责令删除非自愿私密影像(含性化深伪)的平台,是否也须实施"限时下架"(stay-down)措施——如哈希比对——以阻止他人重新上传或再散布;(b) 鉴于"禁用访问指令"只对新加坡用户生效,OSC 有何权力防止此类内容在全球范围内仍可访问。部长杨莉明(Josephine Teo)答复:收到有效举报后,在线安全专员依法可责令在线服务提供商(OSP)对新加坡用户禁用访问指定的有害内容,该指令可延伸覆盖平台上的相同副本;只要达到指令要求的结果,专员不会指定必须采用何种技术,违令即属犯罪。指令仅约束对新加坡用户的访问,但 OSP 可依其自身政策与社群准则移除对其他用户的访问。`,
    ...
    keyPointsKo: [
      `위원은 플랫폼에 지정 유해 콘텐츠에 대한 싱가포르 이용자 접근 차단을 지시할 수 있고 동일 사본으로 확장 가능`,
      `결과가 달성되는 한 특정 기술(해시 매칭 등)은 강제하지 않음; 위반은 범죄`,
      `지시는 싱가포르 이용자 접근만 구속하며, 전 세계 삭제는 플랫폼 자체 정책에 달림`,
    ],
    governmentStance: `政府以"结果导向、技术中立"的方式治理性化深伪等有害内容:赋予在线安全专员直接命令平台禁用访问、并覆盖相同副本的权力,但不锁定具体技术;在承认"禁用指令只及本地用户"这一司法边界的同时,把全球下架留给平台自律。`,
    governmentStanceEn: `The Government governs sexualised deepfakes and similar harms in an outcome-focused, technology-neutral way: it gives the Commissioner power to direct platforms to disable access and cover identical copies, without locking in a specific technology; and while acknowledging the jurisdictional limit that directions reach only local users, it leaves global takedown to platform self-governance.`,
    governmentStanceJa: `政府は性的ディープフェイク等の被害を結果重視・技術中立の方針で統治する。専門官にアクセス遮断と同一コピーへの対応を指示する権限を与える一方、特定技術は固定しない。指示が地元利用者のみに及ぶという管轄上の限界を認めつつ、世界的な削除はプラットフォームの自律に委ねる。`,
    governmentStanceKo: `정부는 성적 딥페이크 등 피해를 결과 중심·기술 중립 방식으로 통치한다. 위원에게 접근 차단과 동일 사본 대응을 지시할 권한을 주되 특정 기술은 고정하지 않는다. 지시가 지역 이용자에게만 미친다는 관할상의 한계를 인정하면서 전 세계 삭제는 플랫폼 자율에 맡긴다.`,
    oppositionStance: null,
    oppositionStanceEn: null,
    oppositionStanceJa: null,
    oppositionStanceKo: null,
    controversyLevel: 1,
    policySignal: `新加坡对深伪与私密影像滥用的治理已从"能否下架"进入"如何防止再上传"的执行细节层面,但明确不把 stay-down 技术写死为强制义务,保留"只要平台达到禁用结果即可"的弹性;跨境可访问性仍是其单边执法难以彻底解决的结构性缺口。`,
    policySignalEn: `Singapore's governance of deepfakes and intimate-image abuse has moved from "can it be taken down?" to the operational detail of "how do we prevent re-uploads?", while deliberately not hard-coding stay-down technology as a mandatory duty — keeping the flexibility of "any means that achieves the disabling outcome." Cross-border accessibility remains a structural gap that unilateral enforcement cannot fully close.`,
    policySignalJa: `シンガポールのディープフェイク・親密画像悪用の統治は「削除できるか」から「再アップロードをどう防ぐか」という運用の細部へ進んだが、stay-down 技術を義務として固定化しないことを選び、「遮断の結果を達成する手段であればよい」という柔軟性を保つ。越境アクセス可能性は一国の執行では完全に閉じられない構造的な隙間として残る。`,
    policySignalKo: `싱가포르의 딥페이크·친밀 이미지 악용 통치는 "삭제할 수 있는가"에서 "재게시를 어떻게 막는가"라는 운용 세부로 나아갔으나, stay-down 기술을 의무로 고정하지 않기로 하며 "차단 결과를 달성하는 수단이면 된다"는 유연성을 유지한다. 국경을 넘는 접근성은 일국의 집행으로는 완전히 닫을 수 없는 구조적 틈으로 남는다.`,
    notableQuote: `在线安全专员依法可责令在线服务提供商对新加坡用户禁用访问指定的有害内容……只要达到指令要求的结果,专员不会指定必须采用何种技术。`,
    notableQuoteEn: `The Commissioner of Online Safety is empowered by law to direct Online Service Providers to disable access by Singapore users to the specified harmful online material ... The Commissioner will not direct that specific technologies be used as long as the outcome indicated in the direction is achieved.`,
    notableQuoteJa: `オンライン安全専門官は法により、オンラインサービス提供者に対し指定の有害コンテンツへのシンガポール利用者のアクセス遮断を指示できる……求める結果が達成される限り、専門官は特定の技術を指定しない。`,
    notableQuoteKo: `온라인안전위원은 법에 따라 온라인서비스제공자에게 지정된 유해 콘텐츠에 대한 싱가포르 이용자의 접근 차단을 지시할 수 있다…… 요구되는 결과가 달성되는 한 위원은 특정 기술을 지정하지 않는다.`,
    ...
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-23654',
    addedAt: '2026-07-20',
  },
  {
    id: 'written-answer-23655',
    titleEn: `Watermarking and Digital Provenance Standards for AI-generated Media, Metadata Preservation and Cross-platform Coordination`,
    title: `AI 生成媒体的水印与数字溯源标准、元数据保存与披露,及跨平台协调措施`,
    titleKo: `AI 생성 미디어의 워터마킹·디지털 출처 표준, 메타데이터 보존과 공개, 크로스 플랫폼 조율`,
    titleJa: `AI 生成メディアの電子透かし・デジタル来歴標準、メタデータの保存と開示、クロスプラットフォーム連携`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Miss Rachel Ong', 'Mrs Josephine Teo'],
    ...
    relatedPostSlugs: [],
    topics: ['Deepfakes & Disinformation', 'AI Governance & Regulation'],
    summary: `王诗尼女士(Rachel Ong)书面质询数字发展与信息部:在管理 AI 相关风险的测试标准与技术方案仍在演进之际,(a) 政府是否在研究 AI 生成媒体的水印或数字溯源标准;(b) 当局能否强制保存并披露可识别原始上传者的元数据;(c) 在各社媒与网站间正在考虑哪些跨平台协调措施。部长杨莉明(Josephine Teo)答复:政府持续跟踪识别 AI 生成内容的技术标准(含水印与数字溯源),并参与相关国际与行业平台,如成员超过 6,000 家、涵盖主要科技与 AI 公司的"内容来源与真实性联盟"(C2PA);随着技术与标准演进,将评估其在新加坡语境下的适用性,包括跨平台措施。若涉及刑事犯罪,警方有权依法要求平台披露信息以协助调查,包括可获得的上传者元数据与可识别数据。`,
    ...
    keyPointsJa: [
      `政府は AI 生成コンテンツの識別標準(電子透かし、デジタル来歴)を追跡するが義務化はせず、国際標準の進展に応じ適用可能性を評価`,
      `「コンテンツ来歴・真正性連合」(C2PA、会員 6,000 超)などの国際・業界プラットフォームに関与`,
      `刑事犯罪の際、警察は投稿者メタデータ等の開示をプラットフォームに求め得る`,
    ],
    keyPointsKo: [
    ...
    governmentStance: `政府在 AI 内容溯源上采取"跟随国际标准、暂不单独立标"的姿态:通过 C2PA 等联盟对接全球技术演进,把强制留给尚未成熟的标准成型之后;当下真正的强制手段来自刑事调查场景下的元数据披露权,而非普遍性的水印义务。`,
    governmentStanceEn: `On provenance for AI content, the Government follows international standards rather than setting its own: it plugs into global technical evolution through coalitions like C2PA and holds mandates back until standards mature. Today's real compulsion comes from metadata-disclosure powers in a criminal-investigation setting, not a general watermarking duty.`,
    governmentStanceJa: `AI コンテンツの来歴について、政府は独自に標準を定めるより国際標準に追随する。C2PA 等の連合を通じて世界の技術的進展に接続し、標準が成熟するまで義務化を控える。現時点の実効的な強制は、一般的な電子透かし義務ではなく、刑事捜査の場面でのメタデータ開示権に由来する。`,
    governmentStanceKo: `AI 콘텐츠 출처에 대해 정부는 독자 표준을 정하기보다 국제 표준을 따른다. C2PA 등 연합을 통해 세계의 기술 진전에 접속하고 표준이 성숙할 때까지 의무화를 미룬다. 현재의 실효적 강제는 일반적 워터마킹 의무가 아니라 형사 수사 국면에서의 메타데이터 공개 권한에서 나온다.`,
    oppositionStance: null,
    oppositionStanceEn: null,
    oppositionStanceJa: null,
    oppositionStanceKo: null,
    controversyLevel: 1,
    policySignal: `新加坡对 AI 生成内容的治理停留在"观察 + 对接国际标准"阶段,刻意不抢先立单边水印标准,以免与全球互操作性脱节;这与其在深伪、选举等高危场景"该立就立"的果断形成对照——溯源技术未成熟前,不轻易上强制。`,
    policySignalEn: `Singapore's governance of AI-generated content sits at a "watch-and-align-with-international-standards" stage, deliberately not front-running a unilateral watermarking standard that could break global interoperability — a contrast with its readiness to legislate decisively in high-risk settings like deepfakes and elections. Until provenance technology matures, it will not rush to mandate.`,
    policySignalJa: `シンガポールの AI 生成コンテンツ統治は「国際標準を注視・整合させる」段階にあり、世界的な相互運用性を損ないかねない一方的な電子透かし標準を先行させないことを選ぶ——ディープフェイクや選挙など高リスク領域で断固立法する姿勢とは対照的だ。来歴技術が成熟するまで、拙速に義務化しない。`,
    policySignalKo: `싱가포르의 AI 생성 콘텐츠 통치는 "국제 표준을 주시·정합"하는 단계에 있으며, 전 세계 상호운용성을 해칠 수 있는 일방적 워터마킹 표준을 선행하지 않기로 한다 — 딥페이크·선거 같은 고위험 영역에서 단호히 입법하는 태도와 대조적이다. 출처 기술이 성숙할 때까지 성급히 의무화하지 않는다.`,
    notableQuote: `政府跟踪识别 AI 生成内容技术标准(含水印与数字溯源)的发展……随着这些技术与标准持续演进,我们将评估其在新加坡语境下的适用性,包括跨平台措施。`,
    notableQuoteEn: `The Government tracks the development of technical standards for identifying AI-generated content, including watermarking and digital provenance approaches ... As these technologies and standards continue to evolve, we will assess their applicability in the Singapore context, including cross-platform measures.`,
    notableQuoteJa: `政府は AI 生成コンテンツを識別する技術標準(電子透かしやデジタル来歴を含む)の発展を追跡している……これらの技術と標準が進展するにつれ、クロスプラットフォーム措置を含めシンガポールの文脈での適用可能性を評価する。`,
    notableQuoteKo: `정부는 AI 생성 콘텐츠를 식별하는 기술 표준(워터마킹과 디지털 출처 포함)의 발전을 추적한다…… 이러한 기술과 표준이 진화함에 따라 크로스 플랫폼 조치를 포함해 싱가포르 맥락에서의 적용 가능성을 평가할 것이다.`,
    ...
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-23655',
    addedAt: '2026-07-20',
  },
  {
    id: 'written-answer-23658',
    titleEn: `Key Risk Thresholds to Regulate High-risk AI Deployments and Mandatory Human Oversight for Fully Automated Decisions`,
    title: `监管高风险 AI 部署的关键风险阈值,及对全自动决策强制人工监督`,
    titleKo: `고위험 AI 배치를 규제하는 핵심 위험 임계값과 완전 자동화 결정에 대한 필수 인간 감독`,
    titleJa: `高リスク AI 展開を規制する主要なリスク閾値と、完全自動化された意思決定への必須の人間による監督`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Mr Alex Yeo', 'Mrs Josephine Teo'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    ...
    summary: `杨益财先生(Alex Yeo)就 NAIS 更新中"必要且有效时将监管或立法"一语,书面质询数字发展与信息部:(a) 哪些关键风险因素或阈值决定何时须对"高风险 AI 部署"进行监管;(b) 部门是否会对实质影响个人的全自动决策(如就业决定或高风险场景)强制要求"有意义的人工监督"。部长杨莉明(Josephine Teo)答复:与任何技术一样,是否监管取决于部署方式、可能造成的伤害性质,以及现有措施是否足以应对。她强调新加坡语境下许多 AI 风险已被现有法律覆盖——用 AI 招聘仍须遵守即将出台的《职场公平法》,《网络犯罪危害法》让警方可阻断 AI 诈骗;现有措施不足且能设计出合适对策时,政府会及时立法(如《选举(网络广告诚信)(修订)法》)。这些法律再辅以分行业指引,如 MAS 就金融业《AI 风险管理指引》咨询、卫生部更新《医疗 AI 指南》(AIHGle 2.0)。政府将持续研究合适的 AI 监管姿态。`,
    ...
    keyPoints: [
      ...
      `以分行业指引(MAS 金融 AI 风险管理、卫生部 AIHGle 2.0)补充硬法`,
    ],
    keyPointsEn: [
    ...
    keyPointsJa: [
      `規制の要否は展開方法・害の性質・既存措置の十分さに依り、一律の「高リスク」閾値は設けない`,
      `多くの AI リスクは既存法で対処済み:AI 採用は《職場公正法》、AI 詐欺は OCHA、ディープフェイクは選挙法`,
      `業界別ガイドライン(MAS の AI リスク管理、保健省 AIHGle 2.0)が硬い法を補完`,
    ],
    keyPointsKo: [
    ...
    governmentStance: `政府拒绝为"高风险 AI"预设统一阈值或普遍性人工监督义务,坚持"按部署与伤害逐案判断、优先复用现有法律"的立场:先看《职场公平法》《网络犯罪危害法》等能否覆盖,不足时才立新法,并用分行业指引柔性收口。这是其"软法为主、必要才立硬法"打法在高风险 AI 上的具体表述。`,
    governmentStanceEn: `The Government declines to preset a uniform "high-risk AI" threshold or a general human-oversight mandate, insisting on a case-by-case judgement by deployment and harm, and on reusing existing law first: it looks to statutes like the Workplace Fairness Act and OCHA before legislating anew, and closes gaps softly through sectoral guidelines. This is its "soft law first, hard law only where necessary" approach as applied to high-risk AI.`,
    governmentStanceJa: `政府は「高リスク AI」に一律の閾値や一般的な人間監督義務を先置きすることを拒み、展開と害に応じた個別判断と既存法の再利用を優先する立場を貫く。《職場公正法》や OCHA などで対処できるかをまず見て、不十分な場合にのみ新法を立て、業界別ガイドラインで柔らかく穴を塞ぐ。これは「まずソフトロー、必要な場合のみ硬い法」という手法の高リスク AI への具体的表現である。`,
    governmentStanceKo: `정부는 "고위험 AI"에 일률적 임계값이나 일반적 인간 감독 의무를 선제적으로 두기를 거부하고, 배치와 해에 따른 개별 판단과 기존 법의 재사용을 우선한다. 《직장공정법》이나 OCHA 등으로 대응할 수 있는지 먼저 보고, 미흡할 때만 새 법을 만들며 산업별 지침으로 부드럽게 틈을 메운다. 이는 "우선 연성법, 필요할 때만 경성법"이라는 방식의 고위험 AI 적용판이다.`,
    oppositionStance: `杨益财援引 NAIS 更新中"必要且有效时将监管或立法"的措辞,追问政府拿出可操作的"高风险 AI"判定阈值,并质询是否会对影响就业等个人重大权益的全自动决策强制人工监督——把"原则性表态"往"具体规则"方向推。`,
    ...
    oppositionStanceJa: `アレックス・ヨーは NAIS 更新の「必要かつ効果的な場合に規制または立法する」を引き、「高リスク AI」を判定する運用可能な閾値を示すよう政府に迫り、雇用など個人に重大な影響を与える完全自動化された意思決定に人間の監督を義務づけるかを問うた——原則的な表明を具体的な規則へと押し進めた。`,
    oppositionStanceKo: `알렉스 여는 NAIS 업데이트의 "필요하고 효과적인 경우 규제 또는 입법한다"를 인용하며 "고위험 AI"를 판정할 운용 가능한 임계값을 제시하라고 정부에 요구하고, 고용 등 개인에게 중대한 영향을 주는 완전 자동화 결정에 인간 감독을 의무화할지 물었다 — 원칙적 표명을 구체적 규칙 쪽으로 밀어붙였다.`,
    controversyLevel: 2,
    policySignal: `面对"要不要给高风险 AI 划线"的直接压力,新加坡明确选择不预设通用阈值、不搞欧盟式风险分级,而是把 AI 风险拆进既有法律(就业、诈骗、选举)逐块处理,再以行业指引兜底。这是其区别于欧盟《AI 法》的核心路径:不立一部综合 AI 法,靠现有工具箱 + 分行业软法动态收紧。`,
    policySignalEn: `Under direct pressure to "draw a line" around high-risk AI, Singapore explicitly chooses not to preset a general threshold or an EU-style risk tiering, instead decomposing AI risk into existing laws (employment, scams, elections) piece by piece, with sectoral guidelines as the backstop. This is the core of its divergence from the EU AI Act: no single comprehensive AI statute, but the existing toolbox plus sectoral soft law, tightened dynamically.`,
    policySignalJa: `高リスク AI に「線を引け」という直接的圧力の下、シンガポールは一般的な閾値や EU 型のリスク階層を先置きしないことを明確に選び、AI リスクを既存法(雇用・詐欺・選挙)へ分解して逐次対処し、業界別ガイドラインで下支えする。これは EU の《AI 法》との相違の核心である:包括的 AI 法を一本作るのではなく、既存の道具箱と業界別ソフトローを動的に締める。`,
    policySignalKo: `고위험 AI에 "선을 그으라"는 직접적 압력 아래, 싱가포르는 일반적 임계값이나 EU식 위험 등급을 선제적으로 두지 않기로 명확히 선택하고, AI 위험을 기존 법(고용·사기·선거)으로 분해해 하나씩 대응하며 산업별 지침으로 받친다. 이는 EU 《AI 법》과의 차이의 핵심이다: 포괄적 AI 법 하나를 만들지 않고 기존 도구함과 산업별 연성법을 동적으로 조인다.`,
    notableQuote: `在新加坡的语境下,许多人工智能(AI)风险已通过现有立法得到应对……现有措施被评估为不足、且能设计出合适对策时,政府会确保其及时落地。`,
    notableQuoteEn: `In Singapore's context, many artificial intelligence (AI) risks are already addressed through existing legislation ... Where existing measures are assessed to be inadequate and a suitable response can be designed, the Government will ensure its timely implementation.`,
    notableQuoteJa: `シンガポールの文脈では、多くの人工知能(AI)リスクは既存の立法で既に対処されている……既存措置が不十分と評価され、適切な対応を設計できる場合、政府はその時宜を得た実施を確保する。`,
    notableQuoteKo: `싱가포르의 맥락에서 많은 인공지능(AI) 위험은 이미 기존 입법으로 다뤄진다…… 기존 조치가 미흡하다고 평가되고 적절한 대응을 설계할 수 있으면, 정부는 그 적시 시행을 보장한다.`,
    transcriptEn: `Referring to the NAIS Update's "regulate or legislate where necessary and effective," Alex Yeo asked MDDI what risk factors or thresholds determine when a high-risk AI deployment warrants regulation, and whether the Ministry would mandate human oversight over fully automated decisions materially affecting individuals such as in employment. Minister Josephine Teo replied that the need to regulate depends on deployment, the nature of harm and whether existing measures are effective; many AI risks are already addressed by existing law (the Workplace Fairness Act, the Online Criminal Harms Act, the elections advertising law), complemented by sectoral guidelines such as MAS's AI Risk Management guidelines and MOH's AIHGle 2.0. The Government will continue to study the appropriate regulatory stance as the technology and risk landscape evolve.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-23658',
    addedAt: '2026-07-20',
  },
  {
    id: 'written-answer-23669',
    titleEn: `Intestate Deaths Data and Integration of AI Tools to Improve Will-writing Accessibility`,
    title: `无遗嘱死亡数据,及整合 AI 工具提升遗嘱订立服务的可及性`,
    titleKo: `무유언 사망 데이터와 유언 작성 서비스 접근성 향상을 위한 AI 도구 통합`,
    titleJa: `無遺言死亡のデータと、遺言作成サービスの利用しやすさ向上のための AI ツール統合`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Mr Gerald Giam Yean Song', 'Mr Edwin Tong Chun Fai'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    ...
    relatedPostSlugs: [],
    topics: ['AI Governance & Regulation', 'AI Safety & Ethics'],
    summary: `工人党议员严燕松(Gerald Giam)书面质询律政部:(a) 部门是否掌握过去五年每年无遗嘱(intestate)去世的新加坡公民与永久居民人数;(b) 是否计划整合人工智能工具,提升遗嘱订立服务的可及性。律政部长唐振辉(Edwin Tong)答复:律政部并不追踪无遗嘱去世人数。他鼓励公众订立遗嘱,并指出如今确有 AI 工具可协助起草遗嘱,但无论是否用 AI,公众都须谨慎,并寻求专业法律意见。政府已推动相关资源更易获取——近期在 MyLegacy@LifeSG 上推出"遗嘱学习工具",帮助公众在寻求法律意见前理解订立遗嘱的考量,并生成可作参考的"遗嘱准备模板";但强调这是教育工具,不能替代法律意见。政府将继续完善身后规划资源,包括"负责任地使用 AI 订立遗嘱"的信息。`,
    ...
    keyPoints: [
      ...
      `已在 MyLegacy@LifeSG 推出"遗嘱学习工具",定位为教育工具而非法律意见替代`,
    ],
    keyPointsEn: [
      `The Ministry of Law does not track intestate deaths`,
      `It acknowledges AI tools can help draft a will, but stresses care and professional legal advice whether or not AI is used`,
      `A Will Learning Tool is live on MyLegacy@LifeSG, framed as an education tool, not a substitute for legal advice`,
    ],
    keyPointsJa: [
      `法務省は無遺言死亡を追跡していない`,
      `遺言作成を補助し得る AI ツールの存在を認めつつ、AI の使用の有無にかかわらず慎重さと専門家の法的助言を強調`,
      `MyLegacy@LifeSG に「遺言学習ツール」を公開、法的助言の代替ではなく教育ツールと位置づけ`,
    ],
    keyPointsKo: [
    ...
    governmentStance: `律政部对 AI 进入法律服务持"欢迎辅助、守住底线"的态度:承认 AI 可协助起草遗嘱、并已推出官方数字工具降低门槛,但反复强调这些只是教育与参考,不能替代专业法律意见,且要求"负责任地使用 AI"。`,
    governmentStanceEn: `The Ministry of Law welcomes AI as an aid to legal services while holding a firm line: it acknowledges AI can help draft a will and has launched an official digital tool to lower the barrier, but repeatedly stresses these are education and reference only — not a substitute for professional legal advice — and calls for the "responsible use of AI."`,
    governmentStanceJa: `法務省は AI を法的サービスの補助として歓迎しつつ、一線を守る。AI が遺言作成を助け得ることを認め、敷居を下げる公式デジタルツールを公開したが、これらは教育・参考にすぎず専門的な法的助言の代替ではないと繰り返し強調し、「AI の責任ある利用」を求める。`,
    governmentStanceKo: `법무부는 AI를 법률 서비스의 보조로 환영하면서도 선을 지킨다. AI가 유언 작성을 도울 수 있음을 인정하고 문턱을 낮추는 공식 디지털 도구를 공개했으나, 이는 교육·참고일 뿐 전문 법률 자문의 대체가 아니라고 거듭 강조하며 "AI의 책임 있는 사용"을 요청한다.`,
    oppositionStance: `工人党严燕松借"无遗嘱死亡"这一民生数据缺口,推动律政部把 AI 用于降低遗嘱订立门槛、提升可及性,把 AI 应用与普通公众的实际法律需求挂钩。`,
    oppositionStanceEn: `Using the data gap on intestate deaths, Workers' Party MP Gerald Giam pushed the Ministry of Law to apply AI to lower the barrier to will-writing and improve accessibility — tying AI adoption to ordinary citizens' real legal needs.`,
    oppositionStanceJa: `労働者党のジェラルド・ギアムは、無遺言死亡というデータの空白を手がかりに、遺言作成の敷居を下げ利用しやすさを高めるため AI を活用するよう法務省に迫り、AI の活用を一般市民の実際の法的ニーズに結び付けた。`,
    oppositionStanceKo: `노동자당 제럴드 지암은 무유언 사망이라는 데이터 공백을 실마리로, 유언 작성의 문턱을 낮추고 접근성을 높이기 위해 AI를 활용하라고 법무부에 요구하며, AI 활용을 일반 시민의 실제 법률 수요에 연결했다.`,
    controversyLevel: 1,
    policySignal: `新加坡把 AI 引入公共法律服务时坚持"工具辅助、人类把关":官方亲自下场做数字工具降低门槛,但同时反复设限——AI 生成的遗嘱只是参考、不能替代律师。这体现了政府在民生领域推广 AI 应用时"提效但不越界、鼓励但强调责任"的一贯尺度。`,
    policySignalEn: `As Singapore brings AI into public legal services, it holds to "tool assists, human decides": the state itself builds a digital tool to lower the barrier, yet repeatedly caps it — an AI-generated will is reference only, not a lawyer. It reflects the Government's consistent measure when promoting AI in citizen-facing domains: raise productivity without overstepping, encourage while stressing responsibility.`,
    policySignalJa: `シンガポールは公共の法的サービスに AI を導入する際、「ツールは補助、人間が決める」を貫く。国自ら敷居を下げるデジタルツールを作りつつ、AI 生成の遺言は参考にすぎず弁護士の代替ではないと繰り返し制限する。市民向け領域で AI 活用を進める際の「効率化するが越えない、奨励するが責任を強調する」という政府の一貫した尺度を映す。`,
    policySignalKo: `싱가포르는 공공 법률 서비스에 AI를 들일 때 "도구는 보조, 인간이 결정"을 지킨다. 국가가 직접 문턱을 낮추는 디지털 도구를 만들면서도, AI가 생성한 유언은 참고일 뿐 변호사의 대체가 아니라고 거듭 제한한다. 시민 대상 영역에서 AI 활용을 추진할 때 "효율화하되 넘지 않고, 권장하되 책임을 강조"하는 정부의 일관된 척도를 보여준다.`,
    notableQuote: `如今确有可用于协助起草遗嘱的人工智能(AI)工具。然而,无论是否使用 AI,公众在订立遗嘱时都必须谨慎,并应寻求专业法律意见。`,
    notableQuoteEn: `There are artificial intelligence (AI) tools today that might be used to assist in preparing a will. However, the public must exercise care in making their wills, whether using AI or not, and should seek professional legal advice.`,
    notableQuoteJa: `今日、遺言作成の補助に使い得る人工知能(AI)ツールが存在する。しかし、AI を使うか否かにかかわらず、公衆は遺言作成に際して慎重を期し、専門家の法的助言を求めるべきである。`,
    notableQuoteKo: `오늘날 유언 작성을 도울 수 있는 인공지능(AI) 도구가 존재한다. 그러나 AI 사용 여부와 무관하게 공중은 유언을 만들 때 신중해야 하며 전문 법률 자문을 구해야 한다.`,
    transcriptEn: `Workers' Party MP Gerald Giam asked the Ministry of Law whether it has data on intestate deaths of Citizens and Permanent Residents over the last five years, and whether it plans to integrate AI tools to improve will-writing accessibility. Minister for Law Edwin Tong replied that the Ministry does not track intestate deaths, encouraged the public to make wills, and noted that AI tools exist that might assist — but stressed care and professional legal advice whether or not AI is used. The Government has launched a Will Learning Tool on MyLegacy@LifeSG that generates a Will Preparation Template for reference, framed as an education tool and not a substitute for legal advice, and will continue improving resources including on the responsible use of AI in will-making.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-23669',
    addedAt: '2026-07-20',
  },
  {
    id: 'written-answer-23694',
    titleEn: `Public Hospital Robotics Deployment, Clinical Outcomes and Long-term Impact on Healthcare Manpower`,
    title: `公立医院机器人部署、临床结果,及对医疗人力的长期影响`,
    titleKo: `공공병원 로봇 배치, 임상 결과, 그리고 의료 인력에 대한 장기적 영향`,
    titleJa: `公立病院のロボット導入、臨床成果、そして医療人材への長期的影響`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Dr Choo Pei Ling', 'Mr Ong Ye Kung'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    relatedTimelineYears: [],
    relatedPostSlugs: [],
    topics: ['AI in Healthcare', 'AI & Employment'],
    summary: `朱倍玲医生(Choo Pei Ling)书面质询社会政策统筹部长兼卫生部长:(a) 目前有多少公立医院部署了(i) 手术机器人与(ii) 物流、清洁、协助病患等非临床服务机器人;(b) 这些机器人对临床结果、病患安全、员工工作量与生产力的实测影响。另问机器人与自动化对护理、专职医疗与支持岗位人力需求的长期影响,以及是否计划追踪并公布岗位重塑与生产力指标。卫生部长王乙康(Ong Ye Kung)答复:国立大学医院、新加坡中央医院、陈笃生医院等公立医院已部署机器人辅助手术(RAS)系统用于微创软组织手术;这些医院具备相应临床能力与足够病例量;就 RAS 适应症而言,临床结果与术后并发症迄今与传统手术相当。机器人与自动化有望提升运营效率、减轻员工工作量、改善病患照护;随着病患数量与工作量上升,合理使用此类技术有助于缓解医疗业(含专职医疗与支持岗位)的人力短缺;适当时机可委托开展详细的学术研究评估其影响。`,
    ...
    keyPoints: [
      ...
      `将在适当时机委托详细学术研究评估其对临床与人力的影响`,
    ],
    keyPointsEn: [
      `Public hospitals (NUH, SGH, TTSH) use robotic-assisted surgery for minimally invasive soft-tissue procedures; outcomes are comparable to conventional surgery`,
      `Robotics and automation are framed as a way to ease manpower shortages and workload, including allied-health and support roles`,
      `A detailed academic study of the clinical and manpower impact could be commissioned at an appropriate time`,
    ],
    keyPointsJa: [
      `公立病院(NUH、SGH、TTSH)は低侵襲の軟部組織手術にロボット支援手術を用い、成果は従来手術と同等`,
      `ロボットと自動化は、コメディカルや支援職を含む人材不足と負担の緩和策と位置づけられる`,
      `臨床と人材への影響を評価する詳細な学術研究を適切な時期に委託し得る`,
    ],
    keyPointsKo: [
      `공공병원(NUH, SGH, TTSH)은 최소 침습 연조직 수술에 로봇 보조 수술을 사용하며 결과는 기존 수술과 비슷함`,
      `로봇과 자동화는 보건의료·지원 직무를 포함한 인력 부족과 업무량 완화 수단으로 규정됨`,
      `임상·인력 영향을 평가하는 상세한 학술 연구를 적절한 시점에 위탁할 수 있음`,
    ],
    governmentStance: `卫生部对医疗机器人持"审慎务实"的推进态度:在有临床能力与足够病例量的医院部署机器人辅助手术,并以"结果与传统手术相当"为安全背书;把机器人与自动化明确定位为应对医疗人力短缺、减负增效的工具,而非取代人力,并保留以学术研究评估长期影响的空间。`,
    governmentStanceEn: `The Ministry of Health advances medical robotics in a cautious, pragmatic way: deploying robotic-assisted surgery in hospitals with the clinical expertise and demand to justify it, with "outcomes comparable to conventional surgery" as the safety warrant; it frames robotics and automation explicitly as a tool to address manpower shortages and lift productivity — not to replace staff — and keeps room to assess long-term impact through academic study.`,
    governmentStanceJa: `保健省は医療ロボットを慎重かつ実務的に進める。臨床的専門性と需要が正当化する病院でロボット支援手術を導入し、「従来手術と同等の成果」を安全の裏づけとする。ロボットと自動化を人材不足への対応と生産性向上の道具として明確に位置づけ、人員の代替ではないとし、学術研究で長期的影響を評価する余地を残す。`,
    governmentStanceKo: `보건부는 의료 로봇을 신중하고 실용적으로 추진한다. 임상 전문성과 수요가 정당화하는 병원에서 로봇 보조 수술을 배치하고 "기존 수술과 비슷한 결과"를 안전의 근거로 삼는다. 로봇과 자동화를 인력 부족 대응과 생산성 향상의 도구로 명확히 규정하되 인력 대체는 아니라고 하며, 학술 연구로 장기 영향을 평가할 여지를 남긴다.`,
    oppositionStance: `朱倍玲医生把问题从"机器人有没有用"推进到"如何量化其影响":要求公布临床结果、病患安全、员工工作量数据,并追问机器人对护理与专职医疗人力需求的长期冲击,以及是否会建立岗位重塑与生产力的追踪指标。`,
    oppositionStanceEn: `Dr Choo Pei Ling pushed the question from "do robots help?" to "how do we quantify the impact?": asking for data on clinical outcomes, patient safety and staff workload, and pressing on the long-term effect of robotics on nursing and allied-health manpower, and whether indicators on job redesign and productivity would be tracked.`,
    oppositionStanceJa: `チュー・ペイリン議員は問いを「ロボットは役立つか」から「影響をどう定量化するか」へ進め、臨床成果・患者安全・職員負担のデータを求め、看護やコメディカルの人材需要へのロボットの長期的影響、及び職務再設計と生産性の指標を追跡するかを問うた。`,
    oppositionStanceKo: `추 페이링 의원은 질문을 "로봇이 도움이 되는가"에서 "영향을 어떻게 정량화하는가"로 밀어붙였다. 임상 결과·환자 안전·직원 업무량 데이터를 요구하고, 간호·보건의료 인력 수요에 대한 로봇의 장기 영향과 직무 재설계·생산성 지표를 추적할지를 물었다.`,
    controversyLevel: 1,
    policySignal: `新加坡把医疗机器人放进"应对人力短缺"的战略框架,而非纯粹的技术升级:以"与传统手术结果相当"为安全底线稳步扩大手术机器人,同时把机器人明确定性为缓解护理与支持岗位人力压力的手段——回应了国会对"AI/自动化是否会冲击医疗就业"的关切,给出"补位而非替代"的官方定调。`,
    policySignalEn: `Singapore places medical robotics inside a "address manpower shortages" strategic frame, not mere tech upgrading: it expands surgical robots steadily on the safety floor of "outcomes comparable to conventional surgery," while defining robotics explicitly as a way to ease manpower pressure in nursing and support roles — answering Parliament's concern about whether AI/automation will hit healthcare jobs with an official framing of "fill the gap, not replace."`,
    policySignalJa: `シンガポールは医療ロボットを、単なる技術更新ではなく「人材不足への対応」という戦略の枠に置く。「従来手術と同等の成果」という安全の下限の上で手術ロボットを着実に拡大しつつ、ロボットを看護や支援職の人材圧力を和らげる手段と明確に定義する——AI・自動化が医療の雇用を打つのかという国会の懸念に、「代替ではなく補完」という公式の位置づけで応える。`,
    policySignalKo: `싱가포르는 의료 로봇을 단순한 기술 업그레이드가 아니라 "인력 부족 대응"이라는 전략의 틀에 둔다. "기존 수술과 비슷한 결과"라는 안전 하한 위에서 수술 로봇을 꾸준히 확대하면서, 로봇을 간호·지원 직무의 인력 압박을 덜어주는 수단으로 명확히 규정한다 — AI·자동화가 의료 고용을 칠지에 대한 국회의 우려에 "대체가 아니라 보완"이라는 공식 규정으로 답한다.`,
    notableQuote: `随着病患数量与工作量上升,合理使用此类技术有助于缓解医疗业(包括专职医疗与支持岗位)长期以来的人力短缺。`,
    notableQuoteEn: `With rising patient numbers and workload, appropriate usage of such technology can help mitigate the manpower shortages in the healthcare sector, including allied health and supportive roles over time.`,
    notableQuoteJa: `患者数と業務量の増加に伴い、こうした技術の適切な使用は、コメディカルや支援職を含む医療分野の人材不足を長期的に緩和するのに役立ち得る。`,
    notableQuoteKo: `환자 수와 업무량이 늘면서, 이러한 기술의 적절한 사용은 보건의료·지원 직무를 포함한 의료 분야의 인력 부족을 장기적으로 완화하는 데 도움이 될 수 있다.`,
    transcriptEn: `Dr Choo Pei Ling asked the Minister for Health how many public hospitals deploy surgical robots and non-clinical service robots, the measured impact on clinical outcomes, patient safety, staff workload and productivity, the long-term impact of robotics and automation on healthcare manpower, and whether indicators on job redesign and productivity would be tracked and published. Minister Ong Ye Kung replied that hospitals such as NUH, SGH and TTSH have deployed robotic-assisted surgical systems for minimally invasive soft-tissue surgeries, with outcomes so far comparable to conventional approaches; robotics and automation can improve efficiency, ease workload and help mitigate manpower shortages including in allied-health and support roles, with a detailed academic study of the impact possible at an appropriate juncture.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-23694',
    addedAt: '2026-07-20',
  },
  {
    id: 'oral-answer-4156',
    titleEn: `Probe into Social Media Posts that Targeted Singapore's Indian Community and Review of National Framework to Counter Such External Influences`,
    title: `调查针对新加坡印度裔社群的社媒帖文，及检讨抵御此类外部影响的国家框架`,
    titleKo: `싱가포르 인도계 커뮤니티를 겨냥한 소셜미디어 게시물 조사와 외부 영향에 대응하는 국가 프레임워크 재검토`,
    titleJa: `シンガポールのインド系コミュニティを標的としたソーシャルメディア投稿の調査と、外部影響に対抗する国家的枠組みの見直し`,
    date: '2026-07-07',
    parliament: '15',
    type: 'Oral Answers to Questions',
    speakers: ['Mr Darryl David', 'Dr Neo Kok Beng', 'Mr Goh Pei Ming'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    relatedTimelineYears: [],
    relatedPostSlugs: [],
    topics: ['AI & National Security', 'Deepfakes & Disinformation', 'AI Governance & Regulation'],
    summary: `人民行动党议员 David（Mr Darryl David）与官委议员梁国荣博士（Dr Neo Kok Beng）就 14 则针对印度裔社群、破坏多元文化的网络社媒帖文，口头质询国家安全统筹部长兼内政部长：调查是否显示这是某机构或组织有协调的行动、将采取何种行动，以及是否检讨抵御此类外部影响的国家框架、如何提升居民的辨识能力。内政部政务部长吴培源（Mr Goh Pei Ming）代部长答复：目前没有证据显示这是某个特定政府或组织的协调行动，相关内容很可能源自一个位于中国的平台后被转载；帖文企图挑起对印度裔社群的敌意、动摇多元种族模式，已被评估触犯《刑法》第 298A(a) 条，政府依据《网络犯罪危害法》（OCHA）发出"禁用指令"，封锁新加坡用户对这 14 则帖文的访问。他指出，近年由人工智能（AI）驱动的不实内容渗入本地信息空间明显增多，尤其 AI 让制造此类帖文变得更容易，政府会仔细追踪每一起案例、调查背后是否有国家行为者介入，并动用 FICA、《维护种族和谐法》、POFMA、OCHA 等立法杠杆主动"向上游"应对（FICA 网络指令自 2024 年 7 月起首次启用且总体有效）。除立法外，政府通过国民教育与全面防卫、SG101 网站、国家图书馆的 S.U.R.E 计划，以及内政部 2025 年针对深伪视频与 AI 生成内容的宣传活动，培养能明辨、有韧性的民众——这被视为对抗分化最有效的防线。`,
    ...
    keyPoints: [
      ...
      `近年 AI 驱动的不实内容渗入本地信息空间明显增多，AI 让制造此类帖文更容易`,
      `政府握有 FICA、《维护种族和谐法》、POFMA、OCHA 等立法杠杆，FICA 网络指令自 2024 年 7 月起首次启用且总体有效`,
      `以国民教育、SG101、S.U.R.E 计划及 2025 年深伪/AI 生成内容宣传活动培养能明辨的民众，被视为对抗分化最有效的防线`,
    ],
    keyPointsEn: [
      `No evidence the 14 posts targeting the Indian community were coordinated by any particular government or organisation; the content likely originated from a China-based platform and was carried onward`,
      `The posts were assessed to breach section 298A(a) of the Penal Code; the Government issued Disabling Directions under OCHA to block Singapore users' access`,
      `AI-enabled, inauthentic content seeping into the local infospace has risen in recent years, with AI making such posts easier to create`,
      `The Government holds legislative levers including FICA, the Maintenance of Racial Harmony Act, POFMA and OCHA; FICA online directions were first used in July 2024 and have been generally effective`,
      `Building a discerning public through National Education, SG101, the S.U.R.E programme and a 2025 deepfake/AI-generated-content campaign is framed as the most effective defence against division`,
    ],
    keyPointsJa: [
      `インド系コミュニティを標的とした14件の投稿が特定の政府や組織によって協調されたという証拠はなく、内容は中国拠点のプラットフォームに由来して転載された可能性が高い`,
      `投稿は刑法第298A条(a)の違反と評価され、政府はOCHAに基づく無効化指令でシンガポール利用者のアクセスを遮断した`,
      `AIを活用した不正確なコンテンツが本地の情報空間に浸透する事例が近年増え、AIがこうした投稿の作成を容易にしている`,
      `政府はFICA、種族調和維持法、POFMA、OCHAなどの立法手段を保持し、FICAのオンライン指令は2024年7月に初めて使われおおむね効果的だった`,
      `国民教育、SG101、S.U.R.Eプログラム、2025年のディープフェイク／AI生成コンテンツ啓発を通じて見識ある国民を育てることを、分断への最も効果的な防御と位置づける`,
    ],
    keyPointsKo: [
      `인도계 커뮤니티를 겨냥한 14건의 게시물이 특정 정부나 조직에 의해 조직되었다는 증거는 없으며, 콘텐츠는 중국 기반 플랫폼에서 비롯되어 전재되었을 가능성이 높다`,
      `게시물은 형법 제298A조(a) 위반으로 평가되었고, 정부는 OCHA에 따른 무력화 지시로 싱가포르 이용자의 접근을 차단했다`,
      `AI 기반의 부정확한 콘텐츠가 현지 정보 공간에 스며드는 사례가 최근 늘었고, AI가 이런 게시물 제작을 쉽게 만든다`,
      `정부는 FICA, 종족화합유지법, POFMA, OCHA 등 입법 수단을 보유하며, FICA 온라인 지시는 2024년 7월 처음 사용되어 대체로 효과적이었다`,
      `국민교육, SG101, S.U.R.E 프로그램과 2025년 딥페이크/AI 생성 콘텐츠 캠페인을 통해 분별력 있는 국민을 기르는 것을 분열에 대한 가장 효과적인 방어로 규정한다`,
    ],
    governmentStance: `政府对 AI 助长的外国干预与分化内容采取"果断执法 + 主动防御 + 全民韧性"三管齐下：以 OCHA、FICA 等既有杠杆果断封堵并强调法律须与时俱进，同时把培养能明辨、有韧性的民众视为最根本的防线，通过教育与宣传主动"接种免疫"。`,
    governmentStanceEn: `The Government takes a three-pronged approach to AI-amplified foreign interference and divisive content — decisive enforcement, proactive defence and population-wide resilience: it blocks content decisively using existing levers such as OCHA and FICA while stressing that laws must stay fit for purpose, and treats a discerning, resilient public as the most fundamental line of defence, "inoculating" citizens through education and outreach.`,
    governmentStanceJa: `政府はAIが増幅する外国干渉と分断的コンテンツに対し、断固たる法執行・先手を打つ防御・国民全体の強靭性という三本柱で臨む。OCHAやFICAなど既存の手段でコンテンツを断固遮断しつつ法は目的に適合し続けるべきだと強調し、見識と強靭さを備えた国民を最も根本的な防御線とみなして、教育と啓発を通じて市民に「免疫を接種」する。`,
    governmentStanceKo: `정부는 AI가 증폭하는 외국 간섭과 분열적 콘텐츠에 대해 단호한 집행·선제적 방어·국민 전체의 회복력이라는 세 축으로 대응한다. OCHA와 FICA 등 기존 수단으로 콘텐츠를 단호히 차단하면서 법이 목적에 계속 부합해야 한다고 강조하고, 분별력 있고 회복력 있는 국민을 가장 근본적인 방어선으로 보아 교육과 홍보를 통해 시민에게 '면역을 접종'한다.`,
    oppositionStance: `提问议员（David、梁国荣）追问：政府是否追踪未公开的潜在协调案例、此类案例是否在上升、若涉及国家行为者将如何应对；并质疑 FICA/POFMA/OCHA 等现行框架偏"事后反应"，要求政府说明有哪些"预防性"举措及其成效如何衡量。`,
    oppositionStanceEn: `The questioning MPs (David, Neo Kok Beng) pressed further: does the Government track possible coordinated cases that are not made public, are such cases rising, and how would it respond if state actors were involved; and they challenged that the current FICA/POFMA/OCHA framework is largely "reactive", asking the Government to spell out its "preventive" measures and how their effectiveness is measured.`,
    oppositionStanceJa: `質問した議員（デイビッド、ネオ・コクベン）はさらに追及した。政府は公開されない潜在的な協調事例を追跡しているか、そうした事例は増えているか、国家主体が関与していた場合どう対応するのか。そして現行のFICA／POFMA／OCHAの枠組みは主に「事後対応的」だと指摘し、どのような「予防的」措置があり、その効果をどう測定するのかを説明するよう求めた。`,
    oppositionStanceKo: `질의한 의원들(데이비드, 네오콕벵)은 더 파고들었다. 정부가 공개되지 않는 잠재적 협조 사례를 추적하는지, 그런 사례가 증가하는지, 국가 행위자가 관련되면 어떻게 대응할지를 물었다. 또 현행 FICA/POFMA/OCHA 프레임워크가 주로 '사후 대응적'이라고 지적하며, 어떤 '예방적' 조치가 있고 그 효과를 어떻게 측정하는지 설명하라고 요구했다.`,
    controversyLevel: 2,
    policySignal: `新加坡把"AI 助长的外国信息操弄"正式纳入国家安全治理视野：一方面确认现有法律工具箱（OCHA、FICA、《维护种族和谐法》、POFMA）足以果断处置并将持续检讨更新，另一方面把重心前移到"全民信息韧性"，显示政府对 AI 生成虚假内容的应对正从"事后封堵"转向"上游预防 + 公众免疫"。`,
    policySignalEn: `Singapore is formally folding "AI-amplified foreign information manipulation" into its national-security governance: it affirms that the existing legal toolbox (OCHA, FICA, the Maintenance of Racial Harmony Act, POFMA) is enough to act decisively and will keep being reviewed, while shifting emphasis upstream to population-wide information resilience — signalling a move from "block after the fact" to "prevent upstream plus inoculate the public" in countering AI-generated falsehoods.`,
    policySignalJa: `シンガポールは「AIが増幅する外国の情報操作」を国家安全保障ガバナンスに正式に組み込みつつある。既存の法的手段（OCHA、FICA、種族調和維持法、POFMA）で断固対処でき、今後も見直すと確認する一方、重心を上流の国民全体の情報強靭性へ移し、AI生成の虚偽への対応を「事後遮断」から「上流での予防＋国民への免疫接種」へと転換する兆しを示している。`,
    policySignalKo: `싱가포르는 'AI가 증폭하는 외국 정보 조작'을 국가안보 거버넌스에 공식적으로 편입하고 있다. 기존 법적 수단(OCHA, FICA, 종족화합유지법, POFMA)으로 단호히 대응할 수 있고 계속 재검토하겠다고 확인하면서, 중심을 상류의 국민 전체 정보 회복력으로 옮겨 AI 생성 허위에 대한 대응을 '사후 차단'에서 '상류 예방 + 국민 면역'으로 전환하는 신호를 보인다.`,
    notableQuote: `我们注意到此类帖文数量有所增加，尤其是因为 AI 让制造这类帖文变得更容易……我们会非常仔细地追踪每一起案例，包括调查背后是否可能有国家行为者。`,
    notableQuoteEn: `We have noticed an increase in the number of such posts, especially given the use of AI enabling the creation of such posts ... we do track very carefully every single case, including investigating whether there are possibly state actors behind the posts.`,
    notableQuoteJa: `こうした投稿の数が増えていることに気づいている。特に、AIがこうした投稿の作成を容易にしているためだ……我々はあらゆる案件を非常に注意深く追跡しており、投稿の背後に国家主体が存在する可能性の調査も含まれる。`,
    notableQuoteKo: `이런 게시물의 수가 증가하고 있음을 인지하고 있으며, 특히 AI가 이런 게시물의 제작을 쉽게 만들기 때문이다…… 우리는 모든 사안을 매우 면밀히 추적하며, 게시물 배후에 국가 행위자가 있을 가능성에 대한 조사도 포함된다.`,
    transcriptEn: `Darryl David and Dr Neo Kok Beng asked the Coordinating Minister for National Security and Minister for Home Affairs whether the 14 online posts targeting the Indian community were a coordinated effort, what action would follow, whether the national framework against external influence would be reviewed, and how residents could be equipped to discern such influence. Minister of State Goh Pei Ming replied that there is no evidence of a coordinated campaign by any government or organisation; the content likely originated from a China-based platform. The posts were assessed to breach section 298A(a) of the Penal Code, and Disabling Directions were issued under OCHA to block the 14 posts. He noted a rise in AI-enabled, inauthentic content in Singapore's infospace, said the Government tracks every case and investigates possible state actors, and set out legislative levers (FICA, the Maintenance of Racial Harmony Act, POFMA, OCHA) alongside public-education efforts — National Education and Total Defence, SG101, the NLB's S.U.R.E programme and a 2025 MHA campaign on deepfakes and AI-generated content — arguing that a discerning public is the most effective defence.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=oral-answer-4156',
    addedAt: '2026-07-16',
  },
  {
    id: 'written-answer-22575',
    titleEn: `Recorded Incidences of AI-Induced Psychosis in Past Three Years and Measures to Address AI-Related Mental Health Issues`,
    title: `过去三年 AI 诱发精神病的记录病例及应对 AI 相关心理健康问题的措施`,
    titleKo: `지난 3년간 AI 유발 정신증 기록 사례와 AI 관련 정신건강 문제 대응 조치`,
    titleJa: `過去3年間のAI誘発精神症の記録症例とAI関連メンタルヘルス問題への対応策`,
    date: '2026-03-04',
    parliament: '15',
    type: 'Written Answers to Questions',
    speakers: ['Ms He Ting Ru', 'Mr Ong Ye Kung'],
    personIds: [],
    topicIds: [],
    relatedPolicyIds: [],
    relatedLeverNumbers: [],
    relatedTimelineYears: [],
    relatedPostSlugs: [],
    topics: ['AI Safety & Ethics', 'AI in Healthcare'],
    summary: `工人党议员何廷儒（He Ting Ru）书面质询社会政策统筹部长兼卫生部长：卫生部是否注意到"AI 诱发精神病"（AI-induced psychosis）记录病例上升；若有，过去三年各年病例数为多少；以及部门如何与相关伙伴合作，更好地研究和应对这一问题。卫生部长王乙康（Ong Ye Kung）答复：国际上确有关于"密集使用人工智能可能引发心理紊乱"的报道，但这尚未成为确立的临床诊断；本地除少数零星个案外，并未观察到此类病例上升的明确趋势。不过他强调，AI 与数字媒体可能带来的健康风险是"真实的关切"，卫生部正对此密切监测。这一问答把"AI 心理健康风险"首次摆上国会台面：反对党推动政府正视并量化新兴风险，政府则以"尚非临床诊断、本地无明显趋势"审慎回应，同时不否认风险、保留持续监测的空间。`,
    ...
    keyPoints: [
      ...
      `卫生部将 AI 与数字媒体的潜在健康风险视为"真实关切"，正密切监测`,
    ],
    keyPointsEn: [
      `"AI-induced psychosis" is not yet an established clinical diagnosis`,
      `Apart from a few anecdotal cases, no clear upward trend has been seen locally`,
      `MOH treats the potential health risk of AI and digital media as a "real concern" and is monitoring closely`,
    ],
    keyPointsJa: [
      `「AI誘発精神症」は現時点で確立された臨床診断ではない`,
      `少数の事例を除き、国内でこうした症例の増加という明確な傾向は見られない`,
      `保健省はAIとデジタルメディアの潜在的な健康リスクを「現実的な懸念」とみなし注視している`,
    ],
    keyPointsKo: [
    ...
    governmentStance: `卫生部对"AI 诱发精神病"持审慎观察态度：不将其认定为已确立的临床诊断，强调本地无明确上升趋势，但承认 AI 与数字媒体的心理健康风险真实存在，将持续密切监测。`,
    governmentStanceEn: `MOH takes a cautious watch-and-monitor stance on "AI-induced psychosis": it does not recognise it as an established clinical diagnosis and stresses there is no clear local upward trend, while acknowledging that the mental-health risks of AI and digital media are real and will be monitored closely.`,
    governmentStanceJa: `保健省は「AI誘発精神症」に対して慎重な観察・監視の立場を取る。確立された臨床診断とは認めず、国内に明確な増加傾向はないと強調する一方、AIとデジタルメディアのメンタルヘルスリスクは現実のものだと認め、引き続き注視するとした。`,
    governmentStanceKo: `보건부는 'AI 유발 정신증'에 대해 신중한 관찰·모니터링 입장을 취한다. 확립된 임상 진단으로 인정하지 않고 국내에 명확한 증가 추세가 없다고 강조하면서도, AI와 디지털 미디어의 정신건강 위험이 실재한다고 인정하고 계속 면밀히 모니터링하겠다고 밝혔다.`,
    oppositionStance: `工人党何廷儒推动政府正视并量化 AI 相关精神健康风险，要求披露过去三年的病例数据，并说明跨伙伴的研究与应对机制。`,
    oppositionStanceEn: `Workers' Party MP He Ting Ru presses the Government to recognise and quantify AI-related mental-health risk, asking it to disclose case numbers over the past three years and to set out its cross-partner research and response mechanisms.`,
    oppositionStanceJa: `労働者党のヒー・ティンルー議員は、AI関連のメンタルヘルスリスクを認識し定量化するよう政府に迫り、過去3年間の症例数の開示と、パートナー横断の研究・対応の仕組みの説明を求めた。`,
    oppositionStanceKo: `노동자당 허팅루 의원은 AI 관련 정신건강 위험을 인정하고 정량화하라고 정부에 촉구하며, 지난 3년간의 사례 수 공개와 파트너 간 연구·대응 체계의 설명을 요구했다.`,
    controversyLevel: 1,
    policySignal: `新加坡卫生部门尚未把"AI 诱发精神病"纳入正式统计或诊断框架，采取"监测优先、暂不立规"的姿态，把 AI 心理健康风险定位为需持续观察的新兴议题，而非既成的公共卫生问题。`,
    policySignalEn: `Singapore's health authorities have not yet folded "AI-induced psychosis" into formal statistics or a diagnostic framework, taking a "monitor first, regulate later" posture that frames AI mental-health risk as an emerging issue to watch rather than an established public-health problem.`,
    policySignalJa: `シンガポールの保健当局は「AI誘発精神症」をまだ公式統計や診断枠組みに組み込んでおらず、「まず監視、規制は後」という姿勢を取り、AIのメンタルヘルスリスクを既成の公衆衛生問題ではなく注視すべき新興課題と位置づけている。`,
    policySignalKo: `싱가포르 보건 당국은 'AI 유발 정신증'을 아직 공식 통계나 진단 체계에 편입하지 않았으며, '우선 모니터링, 규제는 나중에'라는 태도로 AI 정신건강 위험을 기성 공중보건 문제가 아니라 주시해야 할 신흥 과제로 규정한다.`,
    notableQuote: `国际上虽有关于密集使用 AI 可能引发心理紊乱的报道，但这并非确立的临床诊断……我们正密切监测，因为 AI 与数字媒体带来的潜在健康风险确实值得关切。`,
    notableQuoteEn: `There are international reports about psychological disturbances potentially related to intensive AI use, but this is not an established clinical diagnosis ... we are monitoring this closely because the potential health risk posed by AI and digital media is of real concern.`,
    notableQuoteJa: `人工知能の集中的な利用に関連しうる心理的障害についての国際的な報告はあるが、これは確立された臨床診断ではない……AIとデジタルメディアがもたらしうる健康リスクは現実的な懸念であり、我々はこれを注視している。`,
    notableQuoteKo: `인공지능의 집중적 사용과 관련될 수 있는 심리적 장애에 대한 국제적 보고는 있으나, 이는 확립된 임상 진단이 아니다…… AI와 디지털 미디어가 초래할 수 있는 건강 위험은 실질적인 우려이며, 우리는 이를 면밀히 모니터링하고 있다.`,
    transcriptEn: `Ms He Ting Ru asked the Coordinating Minister for Social Policies and Minister for Health three related questions: whether the Ministry is aware of increasing recorded incidences of artificial intelligence (AI)-induced psychosis; if so, the number of cases in each of the past three years; and how the Ministry is working with relevant partners to better study and tackle this issue. Mr Ong Ye Kung replied that there are international reports about psychological disturbances potentially related to intensive AI use, but that this is not an established clinical diagnosis. Other than a few anecdotal cases, no clear trends that such cases are on the rise have been observed locally. Nonetheless, the Minister said the Ministry is monitoring the matter closely, because the potential health risk posed by AI and digital media is of real concern.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-22575',
    addedAt: '2026-06-20',
  },
  {
    id: 'written-answer-22443',
    titleEn: `Energy Consumption Projections of AI Park at one-north and Energy Efficiency Measures`,
    title: `one-north 人工智能园区的能耗预测与能效措施`,
    titleKo: `one-north 인공지능 파크의 에너지 소비 전망과 에너지 효율 조치`,
    titleJa: `one-north の人工知能パークのエネルギー消費見通しとエネルギー効率対策`,
    date: '2026-03-02',
    parliament: '15',
    type: 'Written Answers to Questions',
    ...
    relatedTimelineYears: [],
    relatedPostSlugs: [],
    topics: ['AI Infrastructure & Research', 'AI Governance & Regulation'],
    summary: `工人党议员陈立峰（Dennis Tan）就 one-north 新建人工智能（AI）园区的资源消耗，书面质询数字发展与信息部：园区满负荷运营时的年度电力与水耗预测为多少；部门如何衡量国家 AI 计划（National AI Missions）下企业的软件级能效；以及政府是否会强制大型 AI 模型披露能耗强度，以缓解对全国能源需求的反弹效应。部长杨莉明（Josephine Teo）答复：one-north 的 AI 园区并非数据中心园区，而是面向不断壮大的 AI 开发者与解决方案商社群的聚集地，预计其年度电力与水耗将与榜鹅数码园区等技术密集型工业园相当。她强调新加坡致力于可持续地推进 AI 能力——国家 AI 研发计划已将"资源高效型 AI"列为研究重点；绿色 AI 软件目前仍属新兴领域、尚无国际公认标准，信息通信媒体发展局（IMDA）正与绿色软件基金会合作制定新的"软件碳强度"ISO 标准方法论，并通过"绿色软件试验"与新发布的《企业实用绿色软件指南》推动算力的高效利用；数据中心方面则依托 IMDA 的"绿色数据中心路线图"，部门将通过正在与业界磋商制定的《数字基础设施法案》引入数据中心基线能效标准。`,
    ...
    keyPoints: [
      ...
      `IMDA 正与绿色软件基金会合作制定"软件碳强度"ISO 标准，并推《企业实用绿色软件指南》`,
      `政府将通过《数字基础设施法案》为数据中心引入基线能效标准`,
    ],
    keyPointsEn: [
      `The one-north AI park is positioned as a hub for AI developers and solution providers, not a data-centre park; its energy use is expected to be comparable to the Punggol Digital District`,
      `The National AI R&D plan has named resource-efficient AI a research priority`,
      `IMDA is working with the Green Software Foundation on a Software Carbon Intensity ISO standard and has launched a Practical Green Software Guide for Enterprises`,
      `The Government will introduce baseline energy-efficiency standards for data centres through the Digital Infrastructure Act`,
    ],
    keyPointsJa: [
      `one-north のAIパークはデータセンター・パークではなくAI開発者・ソリューション提供者の拠点と位置づけられ、エネルギー消費はプンゴル・デジタル地区と同程度の見込み`,
      `国家AI研究開発計画は「資源効率の高いAI」を研究の重点とした`,
      `IMDAはグリーンソフトウェア財団と「ソフトウェア炭素強度」ISO標準で協力し、『企業向け実践グリーンソフトウェアガイド』を公表`,
      `政府は「デジタルインフラ法」を通じてデータセンターに基準エネルギー効率基準を導入する`,
    ],
    keyPointsKo: [
      `one-north AI 파크는 데이터센터 파크가 아니라 AI 개발자·솔루션 제공자 허브로 자리매김되며, 에너지 사용은 풍골 디지털 지구와 비슷할 전망`,
      `국가 AI 연구개발 계획은 '자원 효율적 AI'를 연구 우선순위로 삼음`,
      `IMDA는 그린소프트웨어재단과 '소프트웨어 탄소 강도' ISO 표준을 협력하고 『기업용 실용 그린 소프트웨어 가이드』를 발표`,
      `정부는 '디지털 인프라법'을 통해 데이터센터에 기준 에너지 효율 표준을 도입할 예정`,
    ],
    governmentStance: `政府认为 one-north AI 园区能耗可控（对标现有技术密集型园区），主张以"资源高效型 AI"研究、绿色软件国际标准与《数字基础设施法案》的数据中心能效门槛来管理 AI 的能源足迹，暂不单独强制大型模型披露能耗强度。`,
    governmentStanceEn: `The Government holds that the one-north AI park's energy use is manageable (benchmarked against existing technology-intensive estates) and prefers to manage AI's energy footprint through resource-efficient AI research, international green-software standards and the data-centre efficiency thresholds of the Digital Infrastructure Act, rather than mandating energy-intensity disclosures for individual large models for now.`,
    governmentStanceJa: `政府は one-north のAIパークのエネルギー消費は管理可能（既存の技術集約型団地を基準とする）とみなし、当面は個々の大規模モデルにエネルギー強度の開示を義務づけるのではなく、資源効率の高いAI研究、国際的なグリーンソフト標準、「デジタルインフラ法」によるデータセンターの効率基準を通じてAIのエネルギーフットプリントを管理する方針である。`,
    governmentStanceKo: `정부는 one-north AI 파크의 에너지 사용이 관리 가능하다고 보며(기존 기술집약형 단지를 기준), 당분간 개별 대규모 모델에 에너지 강도 공개를 의무화하기보다 자원 효율적 AI 연구, 국제 그린 소프트웨어 표준, '디지털 인프라법'의 데이터센터 효율 기준을 통해 AI의 에너지 발자국을 관리하겠다는 입장이다.`,
    oppositionStance: `工人党陈立峰推动量化披露：要求公开园区满负荷能耗预测、建立软件级能效衡量方法，并强制大型 AI 模型披露能耗强度，以防 AI 扩张抬高全国能源需求的反弹效应。`,
    oppositionStanceEn: `Workers' Party MP Dennis Tan Lip Fong pushes for quantified disclosure: he asks for published full-capacity energy projections for the park, a method to measure software-level energy efficiency, and mandatory energy-intensity disclosures for large AI models to guard against a rebound effect on national energy demand from AI expansion.`,
    oppositionStanceJa: `労働者党のデニス・タン議員は定量的な開示を求める。すなわち、パークのフル稼働時のエネルギー見通しの公表、ソフトウェアレベルのエネルギー効率の測定方法、そしてAIの拡大が全国のエネルギー需要に及ぼすリバウンド効果を防ぐための大規模AIモデルへのエネルギー強度開示の義務づけである。`,
    oppositionStanceKo: `노동자당 데니스 탄 의원은 정량적 공개를 요구한다. 즉 파크의 완전 가동 시 에너지 전망 공표, 소프트웨어 차원 에너지 효율 측정 방법, 그리고 AI 확장이 전국 에너지 수요에 미치는 반등 효과를 막기 위한 대규모 AI 모델의 에너지 강도 공개 의무화이다.`,
    controversyLevel: 1,
    policySignal: `新加坡倾向以行业国际标准、绿色软件指南与《数字基础设施法案》的数据中心能效门槛来约束 AI 能耗，监管重心落在基础设施层而非模型层，暂不对单个大型模型施加强制能耗披露义务。`,
    policySignalEn: `Singapore leans toward curbing AI energy use through international industry standards, green-software guidance and the data-centre efficiency thresholds of the Digital Infrastructure Act — placing the regulatory centre of gravity at the infrastructure layer rather than the model layer, and stopping short of mandatory energy disclosures for individual large models.`,
    policySignalJa: `シンガポールは、国際的な業界標準、グリーンソフトの指針、「デジタルインフラ法」によるデータセンターの効率基準を通じてAIのエネルギー消費を抑える方向に傾いており、規制の重心をモデル層ではなくインフラ層に置き、個々の大規模モデルへのエネルギー開示義務化には踏み込んでいない。`,
    policySignalKo: `싱가포르는 국제 업계 표준, 그린 소프트웨어 지침, '디지털 인프라법'의 데이터센터 효율 기준을 통해 AI 에너지 소비를 억제하는 쪽으로 기울어 있으며, 규제의 무게중심을 모델 계층이 아니라 인프라 계층에 두고 개별 대규모 모델에 대한 에너지 공개 의무화에는 나아가지 않았다.`,
    notableQuote: `one-north 的人工智能园区并非数据中心园区，而是面向不断壮大的 AI 开发者与解决方案商社群的聚集地。`,
    notableQuoteEn: `The planned Artificial Intelligence (AI) park at one-north is not a data centre park. It is designed to be a hub for a growing community of AI developers and solution providers.`,
    notableQuoteJa: `one-north に計画されている人工知能（AI）パークはデータセンター・パークではない。成長を続けるAI開発者・ソリューション提供者のコミュニティの拠点となるよう設計されている。`,
    notableQuoteKo: `one-north에 계획된 인공지능(AI) 파크는 데이터센터 파크가 아니다. 성장하는 AI 개발자·솔루션 제공자 커뮤니티의 허브가 되도록 설계되었다.`,
    transcriptEn: `Mr Dennis Tan Lip Fong asked the Minister for Digital Development and Information three related questions about the new artificial intelligence (AI) park at one-north: the projected annual electricity and water consumption at full capacity; how the Ministry would measure software-level energy efficiency for firms under the national AI Missions; and whether the Government would mandate energy-intensity disclosures for large-scale AI models to mitigate any rebound effect on national energy demand. Mrs Josephine Teo replied that the planned AI park is not a data centre park but is designed to be a hub for a growing community of AI developers and solution providers, so its annual electricity and water consumption is expected to be comparable to other technology-intensive industrial estates such as the Punggol Digital District. She added that Singapore is committed to advancing its AI capabilities sustainably: under the National AI Research and Development plan, resource-efficient AI has been identified as a research priority, which together with close monitoring of practices elsewhere will inform appropriate policy measures. On software, she noted that green or energy-efficient AI software is still a nascent field with no internationally recognised standard today; the Infocomm Media Development Authority (IMDA) is working closely with the Green Software Foundation on the methodology for the new Software Carbon Intensity ISO standard, and in the meantime promotes the efficient use of computing resources through initiatives such as the Green Software Trials and the recently launched Practical Green Software Guide for Enterprises. On data centres, she said steps had been taken to improve sustainability through IMDA's Green DC roadmap, and that the Ministry will introduce baseline energy-efficiency standards for data centres through the Digital Infrastructure Act, which is being developed in consultation with the industry.`,
    sourceUrl: 'https://sprs.parl.gov.sg/search/#/sprs3topic?reportid=written-answer-22443',
    addedAt: '2026-06-20',
  },
  {
...
export const DEBATE_STATS = {
  ...
  byType: {
    'Written Answers to Questions': 68,
    Motions: 7,
    'Oral Answers to Questions': 53,
    Budget: 59,
  },
  byTopic: {
    'AI Economy & Industry': 90,
    'AI & National Security': 82,
    'AI Governance & Regulation': 80,
    'AI in Public Sector': 70,
    'AI Safety & Ethics': 62,
    'AI & Employment': 57,
    'AI Infrastructure & Research': 53,
    'AI in Education': 46,
    'AI in Healthcare': 22,
    'AI Strategy': 20,
    'Deepfakes & Disinformation': 11,
  },
  topSpeakers: {
