...
export const jobsIndexSnapshots: JobsIndexSnapshot[] = [
  {
    ...
    queryTotals: {
      ...
      'machine learning': 1055,
      LLM: 532,
      'AI engineer': 405,
    },
    salaryDisclosureRate: 0.991,
    disclosedCount: 1818,
    salaryMidpointP25: 5250,
    salaryMidpointMedian: 7130,
    salaryMidpointP75: 9750,
    topEmployers: [
      { employer: 'PERSOL SINGAPORE PTE. LTD.', openings: 232 },
      { employer: 'THE SUPREME HR ADVISORY PTE. LTD.', openings: 46 },
      { employer: 'RN CARE PTE. LTD.', openings: 45 },
      { employer: 'NANYANG TECHNOLOGICAL UNIVERSITY', openings: 39 },
      { employer: 'NATIONAL UNIVERSITY OF SINGAPORE', openings: 32 },
      { employer: 'SCIENTEC CONSULTING PTE. LTD.', openings: 28 },
      { employer: 'RECRUITPEDIA PTE. LTD.', openings: 26 },
      { employer: 'BYTEDANCE PTE. LTD.', openings: 25 },
      { employer: 'MICRON SEMICONDUCTOR ASIA OPERATIONS PTE. LTD.', openings: 23 },
      { employer: 'A*STAR RESEARCH ENTITIES', openings: 22 },
    ],
    roleTypes: [
      { roleType: 'engineering', count: 804 },
      { roleType: 'research', count: 293 },
      { roleType: 'data', count: 162 },
      { roleType: 'product', count: 23 },
      { roleType: 'gtm', count: 85 },
      { roleType: 'ops-other', count: 467 },
    ],
    sectors: [
      { sector: 'tech', count: 1041 },
      { sector: 'finance', count: 129 },
      { sector: 'health', count: 106 },
      { sector: 'manufacturing', count: 100 },
      { sector: 'logistics', count: 33 },
      { sector: 'gov-edu', count: 71 },
      { sector: 'other', count: 354 },
    ],
