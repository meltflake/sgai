...
export const dataDisclaimer =
  '数据截至 2026 年 6 月，GitHub stars 为近似值。统计采集：2026-05-04；项目档案更新：2026-05-04。如有遗漏或错误，欢迎提交 Issue。';
export const dataDisclaimerEn =
  'Data is current as of June 2026; GitHub star counts are approximate. Stats collected: 2026-05-04; project profiles updated: 2026-05-04. Please open an Issue if you spot omissions or errors.';
