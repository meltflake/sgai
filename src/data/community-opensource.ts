...
export const universityProjects: OpenSourceProject[] = [
  {
    ...
    metrics: [
      ...
      { label: '核心场景', labelEn: 'Core use case', value: '大模型训练', valueEn: 'large-model training' },
      { label: '形态', labelEn: 'Form', value: '训练系统', valueEn: 'training system' },
    ],
    summary:
...
For sgai.md, it is a long-running sample of whether Singapore can export general AI engineering infrastructure.`,
    milestones: [
      { date: '2021-10', title: 'Colossal-AI 仓库创建', titleEn: 'Colossal-AI repository created' },
      {
        date: '2023-2024',
        title: '进入大模型训练工具主流视野',
    ...
    resources: [
      ...
      { label: 'Colossal-AI 官网', labelEn: 'Colossal-AI website', url: 'https://www.colossalai.org', kind: 'website' },
  ...
  },
  {
    ...
    updated: '2026-05-04',
    metrics: [
      { label: '生态 Stars', labelEn: 'Ecosystem stars', value: '30k+' },
      { label: '代表项目', labelEn: 'Flagship project', value: 'MMDetection' },
      { label: '核心领域', labelEn: 'Core domain', value: '视觉 AI', valueEn: 'vision AI' },
    ],
    summary:
...
The point to watch is how OpenMMLab connects with multimodal, robotics, and edge-AI toolchains rather than remaining only in classical vision tasks.`,
    milestones: [
      ...
      { date: '2020s', title: '形成 OpenMMLab 工具箱生态', titleEn: 'OpenMMLab grows into a toolbox ecosystem' },
    ],
    resources: [
      {
      ...
      { label: 'OpenMMLab 官网', labelEn: 'OpenMMLab website', url: 'https://openmmlab.com', kind: 'website' },
    ],
  },
  {
    id: 'next-gpt',
    ...
    metrics: [
      ...
      { label: '论文', labelEn: 'Paper', value: 'ICML 2024' },
      {
        label: '模态',
        labelEn: 'Modalities',
        value: '文本 / 图像 / 视频 / 音频',
...
This page is a place to keep adding citations, follow-on models, industrial translation, and links to other NUS multimodal teams.`,
    milestones: [
      { date: '2023-08', title: 'NExT-GPT 仓库发布', titleEn: 'NExT-GPT repository released' },
      { date: '2024', title: '论文发表于 ICML 2024', titleEn: 'Paper published at ICML 2024' },
    ],
    resources: [
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '论文', labelEn: 'Papers', value: 'ICLR / NeurIPS' },
      { label: '核心能力', labelEn: 'Core capability', value: '理解 + 生成', valueEn: 'understanding + generation' },
    ],
    summary:
...
Future tracking should cover Show Lab’s model series, paper acceptances, Hugging Face usage, and whether the work turns into production tools.`,
    milestones: [
      { date: '2024-08', title: 'Show-o 仓库创建', titleEn: 'Show-o repository created' },
      { date: '2025-01', title: 'Show-o 接收为 ICLR 2025 论文', titleEn: 'Show-o accepted to ICLR 2025' },
      { date: '2025-09', title: 'Show-o2 接收为 NeurIPS 2025 论文', titleEn: 'Show-o2 accepted to NeurIPS 2025' },
    ],
    resources: [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '论文', labelEn: 'Paper', value: 'CVPR 2025' },
      { label: '方向', labelEn: 'Direction', value: 'Computer Use' },
    ],
...
If GUI agents become a general capability, work such as ShowUI becomes a base module connecting models to real software workflows.`,
    milestones: [
      { date: '2024-10', title: 'ShowUI 仓库创建', titleEn: 'ShowUI repository created' },
      { date: '2025-02', title: 'ShowUI 接收为 CVPR 2025 论文', titleEn: 'ShowUI accepted to CVPR 2025' },
    ],
    resources: [
      { label: 'ShowUI GitHub', labelEn: 'ShowUI on GitHub', url: 'https://github.com/showlab/ShowUI', kind: 'github' },
      { label: 'ShowUI 论文', labelEn: 'ShowUI paper', url: 'https://arxiv.org/abs/2411.17465', kind: 'paper' },
      {
        label: 'Show Lab Hugging Face',
        labelEn: 'Show Lab on Hugging Face',
        url: 'https://huggingface.co/showlab',
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '核心场景', labelEn: 'Core use case', value: '视频生成', valueEn: 'video generation' },
      { label: '形态', labelEn: 'Form', value: '系统框架', valueEn: 'system framework' },
    ],
    summary:
...
That is especially realistic for Singapore, where compute is a visible constraint.`,
    milestones: [{ date: '2024-02', title: 'VideoSys 仓库创建', titleEn: 'VideoSys repository created' }],
    resources: [
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '论文', labelEn: 'Paper', value: 'ICML 2024' },
      { label: '任务', labelEn: 'Tasks', value: '时序分析', valueEn: 'time-series analysis' },
    ],
...
This page can later add concrete benchmarks, datasets, and whether local industry applications emerge.`,
    milestones: [
      { date: '2024-04', title: 'TSLANet 论文和代码公开', titleEn: 'TSLANet paper and code released' },
      { date: '2024', title: '论文发表于 ICML 2024', titleEn: 'Paper published at ICML 2024' },
    ],
    resources: [
      {
      ...
      { label: 'TSLANet 论文', labelEn: 'TSLANet paper', url: 'https://arxiv.org/abs/2404.08472', kind: 'paper' },
    ],
  },
];
...
export const corporateLabProjects: OpenSourceProject[] = [
  {
    ...
    metrics: [
      ...
      { label: '代表模型', labelEn: 'Flagship models', value: 'BLIP / BLIP-2' },
      { label: '方向', labelEn: 'Direction', value: '图文理解', valueEn: 'image-text AI' },
    ],
    summary:
...
This is an important but often underestimated layer of Singapore’s AI ecosystem: multinational labs connect local talent, global research networks, and open-source influence.`,
    milestones: [
      { date: '2022', title: 'BLIP 论文发表于 ICML 2022', titleEn: 'BLIP paper published at ICML 2022' },
      { date: '2023', title: 'BLIP-2 论文发表于 ICML 2023', titleEn: 'BLIP-2 paper published at ICML 2023' },
    ],
    resources: [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '方向', labelEn: 'Direction', value: '代码生成', valueEn: 'code generation' },
      { label: '形态', labelEn: 'Form', value: '模型家族', valueEn: 'model family' },
    ],
...
On this site, it is a reminder that Singapore’s AI influence does not only come from government and universities, but also from global projects connected to multinational research teams here.`,
    milestones: [{ date: '2022-03', title: 'CodeGen 仓库创建', titleEn: 'CodeGen repository created' }],
    resources: [
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '方向', labelEn: 'Direction', value: '多模态统一', valueEn: 'unified multimodal' },
      { label: '形态', labelEn: 'Form', value: '模型仓库', valueEn: 'model repo' },
    ],
...
The points to track: Singapore teams’ actual role in training, data, evaluation, or product; and whether these open projects attract local developers.`,
    milestones: [{ date: '2025-04', title: 'BAGEL 仓库创建', titleEn: 'BAGEL repository created' }],
    resources: [
      {
        label: 'BAGEL GitHub',
  ...
  },
  {
    ...
    updated: '2026-05-04',
    metrics: [
      { label: '代表模型', labelEn: 'Representative models', value: '2B / 7B' },
      { label: '平台', labelEn: 'Platform', value: 'Hugging Face' },
      { label: '方向', labelEn: 'Direction', value: '视频理解', valueEn: 'video understanding' },
    ],
...
Projects like this help track how Singapore hosts global AI research networks from Chinese technology companies.`,
    milestones: [{ date: '2025', title: 'VideoLLaMA3 模型线发布', titleEn: 'VideoLLaMA3 model line released' }],
    resources: [
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '论文', labelEn: 'Paper', value: 'EMNLP 2024' },
      { label: '区域', labelEn: 'Region', value: '东南亚', valueEn: 'Southeast Asia' },
    ],
...
It should be tracked alongside SEA-LION: one is the national-platform route, the other a homegrown tech-company lab route.`,
    milestones: [
      { date: '2024-02', title: 'Sailor LLM 仓库创建', titleEn: 'Sailor LLM repository created' },
      { date: '2024', title: '论文发表于 EMNLP 2024', titleEn: 'Paper published at EMNLP 2024' },
    ],
    resources: [
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '方向', labelEn: 'Direction', value: '模型对齐', valueEn: 'model alignment' },
      { label: '形态', labelEn: 'Form', value: '训练框架', valueEn: 'training framework' },
    ],
...
Future tracking should watch whether it is used in Sailor or other SAIL model-training pipelines.`,
    milestones: [{ date: '2024-10', title: 'OAT 仓库创建', titleEn: 'OAT repository created' }],
    resources: [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: '方向', labelEn: 'Direction', value: '流水线并行', valueEn: 'pipeline parallelism' },
      { label: '目标', labelEn: 'Goal', value: '减少空泡', valueEn: 'reduce pipeline bubbles' },
    ],
    summary:
...
Together with Colossal-AI, it forms the "training systems" line in Singapore’s open-source ecosystem.`,
    milestones: [{ date: '2023-11', title: 'Zero-Bubble 仓库创建', titleEn: 'Zero-Bubble repository created' }],
    resources: [
      {
...
export const startupProjects: OpenSourceProject[] = [
  {
    ...
    metrics: [
      ...
      { label: '形态', labelEn: 'Form', value: '桌面应用', valueEn: 'desktop app' },
      { label: '核心卖点', labelEn: 'Core promise', value: '本地运行', valueEn: 'runs locally' },
    ],
    summary:
...
Its significance for Singapore’s AI startup ecosystem is direct: open source can be a growth channel, a trust mechanism, and an entry point into developer community.`,
    milestones: [
      { date: '2023-08', title: 'Jan 仓库创建', titleEn: 'Jan repository created' },
      { date: '2024-2026', title: '本地 AI 助手方向快速升温', titleEn: 'Local AI assistant category grows quickly' },
    ],
    resources: [
      { label: 'Jan GitHub', labelEn: 'Jan on GitHub', url: 'https://github.com/janhq/jan', kind: 'github' },
      { label: 'Jan 官网', labelEn: 'Jan website', url: 'https://jan.ai', kind: 'website' },
    ],
  },
];
