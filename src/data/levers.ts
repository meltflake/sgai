...
export const levers: Lever[] = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          {
            id: 'ai-and-data-driven-government',
            name: '人工智能与数据驱动政府',
            nameEn: 'AI and Data Driven Government',
            ministry: 'Auto: 待审核',
            ministryEn: 'Auto: pending review',
            description: '新加坡政府技术局（GovTech）通过数据科学和人工智能促进全政府采纳数据和AI技术，以增强政府服务和平台。GovTech与政府机构合作建立内部数据科学专业知识、制定数据战略、部署AI和数据服务，并跨政府建立数据基础设施。该局开发了WOGAA（全政府应用分析）、Pair（政府专用的ChatGPT替代品）和VICA（虚拟智能聊天助手）等产品，以提升政府数字服务的绩效、市民互动和运营效率。',
            descriptionEn: 'Singapore\'s Government Technology Agency (GovTech) facilitates whole-of-government adoption of data and AI to enhance government services and platforms. GovTech collaborates with government agencies to build in-house data science expertise, develop data strategies, deploy AI and data services, and establish data infrastructures across government. The agency develops key products including WOGAA (Whole-of-Government-Application-Analytics) for monitoring digital service performance, Pair (a secure ChatGPT alternative for public officers), and VICA (Virtual Intelligent Chat Assistant) to enable government chatbots, ultimately improving policy outcomes, service delivery, and operational efficiency.',
            sourceUrl: 'https://www.tech.gov.sg/about-us/what-we-do/our-digital-government-efforts/ai-and-data-driven-government/',
          },
          {
            id: 'sustainability',
            name: '可持续发展',
            ...
            ministry: 'Auto: 待审核',
            ministryEn: 'Auto: pending review',
            description: '新加坡政府技术局（GovTech）在新加坡绿色计划2030框架下推动可持续发展，致力于到2045年实现净零排放，领导公共部门的技术脱碳。GovTech通过数字工作场所、政府主机和云迁移、绿色软件、开放数字平台等举措，在整个价值链中减少环境影响，为新加坡实现智能可持续的未来做出贡献。',
            descriptionEn: 'GovTech plays a key role in Singapore\'s Green Plan 2030, driving sustainability through net-zero emissions targets and eco-friendly digital solutions. The agency aims to achieve net zero emissions around 2045, aligned with the public sector\'s leadership commitment. Core initiatives include digital workplace alternatives, energy-efficient government hosting and cloud consolidation, green software optimization, and the Open Digital Platform to enable smarter district planning with potential 30% reductions in energy and water consumption.',
            sourceUrl: 'https://www.tech.gov.sg/about-us/what-we-do/our-digital-government-efforts/sustainability/',
          },
          {
            id: 'aibots-government-ai-chatbot-platform',
            name: 'AIBots：政府人工智能聊天机器人平台',
            nameEn: 'AIBots: Government AI Chatbot Platform',
            ministry: 'Auto: 待审核',
            ministryEn: 'Auto: pending review',
            description: 'AIBots是新加坡政府技术局推出的平台，允许政府机构在15分钟内创建定制化的生成式AI聊天机器人。该平台支持上传内部知识库、配置机器人参数、自定义机器人个性和性能，已被政府各部门广泛采用，创建了4000多个机器人，有13000多名用户。',
            descriptionEn: 'AIBots is a platform by Singapore\'s Government Technology Agency enabling government agencies to create customised generative AI chatbots in 15 minutes. The platform supports uploading internal knowledge bases, configuring bot parameters, and personalising bot behaviour. It has achieved widespread adoption across government, with over 4,000 bots created by 13,000+ users across government agencies.',
            sourceUrl: 'https://www.tech.gov.sg/gtpc-product-1/',
          },
          {
            id: 'smart-nation-fellowship-programme',
            name: '智慧国家奖学金计划',
            nameEn: 'Smart Nation Fellowship Programme',
            ministry: 'Auto: 待审核',
            ministryEn: 'Auto: pending review',
            description: '新加坡政府技术机构GovTech推出的3至12个月技术人才项目，招募人工智能、区块链、云计算、数据科学、应用开发、网络安全和物联网领域的专家。参与者与同行协作共创新解决方案，推动新加坡智慧国家建设。该计划支持全职或根据日程灵活安排的兼职咨询。',
            descriptionEn: 'A 3 to 12-month fellowship programme launched by GovTech (Government Technology Agency of Singapore) to recruit tech experts in AI, blockchain, cloud computing, data science, app development, cybersecurity, and IoT. Fellows collaborate with like-minded professionals to co-create innovative solutions driving Singapore\'s Smart Nation vision. The programme offers flexible part-time consultancy arrangements based on individual schedules.',
            sourceUrl: 'https://www.tech.gov.sg/careers/opportunities-for-professionals/smart-nation-fellowship-programme/',
          },
          {
            id: 'smart-nation-scholarship',
            name: '智慧国家奖学金',
            nameEn: 'Smart Nation Scholarship',
            ministry: 'Auto: 待审核',
            ministryEn: 'Auto: pending review',
            description: '新加坡政府技术局（GovTech）、网络安全局（CSA）和信息通信媒体发展局（IMDA）联合推出的奖学金计划，旨在培养致力于推动新加坡数字化转型的科技人才。奖学金获得者将获得雇主赞助的培训、进入技术副经理项目（TAP）的机会、导师指导、网络拓展及跨部门轮换机会。该计划强调将创新用于公共利益，并培养具有目标驱动、同理心和人才发展能力的领导者。',
            descriptionEn: 'A joint scholarship programme offered by Singapore\'s Government Technology Agency (GovTech), Cyber Security Agency (CSA), and Infocomm Media Development Authority (IMDA) to nurture talented individuals passionate about technology and Singapore\'s digital transformation. Scholars receive employer-sponsored training, direct entry to GovTech\'s Technology Associate Programme (TAP), mentorship, networking opportunities, and exposure to different technology tracks. The programme emphasizes using innovation for public good and developing leaders who embody purpose, empathy, and people development.',
            sourceUrl: 'https://www.tech.gov.sg/careers/students-and-graduates/smart-nation-scholarship/',
          },
        ],
      },
    ],
