...
export const sections: ReferenceSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        text: 'Computer Weekly — Singapore pushes for global standard to test generative AI',
      ...
      {
        text: 'TNGlobal — Singapore pushes first international benchmark for generative AI testing',
