...
全体の経緯は[こちらのまとめ](https://r.slax.com/b/b62e302c-397a-4df0-b7ba-165f7160dc1c)にあり、OpenAI、METR、Hugging Face それぞれの独立した調査が含まれています。細部を読み通すには、ある程度の情報セキュリティの知識が必要かもしれません。簡単に説明します。
