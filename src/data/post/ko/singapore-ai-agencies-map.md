...
title: '싱가포르에서 AI를 담당하는 부처와 각자의 담당 범위'
excerpt: '싱가포르에는 "AI 부처"가 없다. AI에 얽힌 부처와 법정기관은 40개가 넘고 각자 한 구간을 맡는다. 총리실이 방향을 정하고, MDDI가 국가 전략을 쓰고, IMDA가 거버넌스 기준선을 쥐고, EDB가 외자를 유치하고, GovTech가 정부 안에서 먼저 쓴다.'
category: 관찰
topicIds:
  - national-strategy
