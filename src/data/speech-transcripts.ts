...
export const speechTranscripts: Record<string, SpeechTranscript> = {
  ...
  'remarks-by-mos-rahayu-mahzam-at-the-launch-of-lions-befrienders--new-neighbourhood-assistant-for-nurturing-ageing--nana--ai-initiative':
    {
      speechId: `remarks-by-mos-rahayu-mahzam-at-the-launch-of-lions-befrienders--new-neighbourhood-assistant-for-nurturing-ageing--nana--ai-initiative`,
      sourceUrl: `https://www.mddi.gov.sg/newsroom/remarks-by-mos-rahayu-mahzam-at-the-launch-of-lions-befrienders--new-neighbourhood-assistant-for-nurturing-ageing--nana--ai-initiative/`,
      sourceLanguage: 'en',
      fetchedAt: `2026-05-15`,
      source: 'mddi-newsroom',
      paragraphs: [
        `开场`,
        `各位下午好！很高兴今天来到 Lions Befrienders。`,
        `每次走访乐龄活动中心（Active Ageing Centre），我都会带着满满的能量离开。在我们的乐龄人士和服务工作者身上看到的「我能行」的精神——真的会感染人。`,
        `今天我们齐聚一堂——庆祝这种创新精神。我非常高兴能与各位共同见证「邻里安老智能助理」（Neighbourhood Assistant for Nurturing Ageing），也就是 NANA，正式启动。`,
        `在老龄化社会中转型社区护理`,
        `到 2030 年，每四位新加坡人中就有一位年满 65 岁——其中又有四分之一年满 80 岁。我们希望乐龄人士保持健康、活跃、与社会保持连接——希望他们被妥善支持，尽可能长地在社区生活。`,
        `科技可以助我们达成这个目标。比如说——乐龄人士可以在 LifeSG App（一个整合了超过 100 项政府服务的应用）上做幸福感问卷，拿到自己身心状态的总结，外加个性化建议，例如附近的乐龄活动项目。`,
        `科技还能让我们向上游延伸——把对乐龄人士的支持扩得更广。我们希望打造一个「始终有人在关心你」的社区——不只是在你不舒服的时候，而是在任何事情出错之前。要让这个愿景成真——我们需要把科技拥抱为「护理的赋能者」。`,
        `借助科技守护乐龄`,
        `NANA 正是这种思路的体现。它是一个 AI 驱动的语音助理——可以自动化地用乐龄人士偏好的语言或方言做关怀电话陪聊。每次对话后——NANA 会为 Lions Befrienders 的工作人员提供要点总结、并高亮任何需要跟进的事项。这位 AI 语音「友伴」展示了——我们如何借助科技，在访问与中心活动之间，照看乐龄人士的情绪与心理健康。`,
        `我知道——当我们谈到 AI——有人会担心「人情味」会丢失。但这不是「科技替代人」——而是「科技支持人」。我们可以把 NANA 这类 AI 工具看作「眼睛和耳朵」，去支持我们护理工作者的「心」。NANA 处理掉与乐龄人士的例行关怀电话——让我们的员工与义工得以专注做他们最擅长的事：提供深度、有意义的、唯有人类才能给予的陪伴与支持。`,
        `我了解到——Yoganathan 先生待会儿会分享他使用 NANA 的经历，以及 NANA 是如何打开了他对 AI 的认知。我很期待听他的分享。`,
        `肯定来自一线的创新`,
        `我要向 Lions Befrienders 致敬——感谢你们过去几年的非凡工作——一点一滴打磨、「教」NANA 更好地理解并回应我们的新加坡乐龄人士。感谢你们的创新——感谢你们一直在思考如何在社区中更好地照护乐龄长辈。我也期待看到——NANA 如何转型乐龄护理。`,
        `结语`,
        `现场所有的乐龄长辈——我希望你们能敞开心扉欢迎 NANA。不要害羞——和 NANA 聊聊——分享你的想法和反馈——帮助这些工具变得更适合你。因为——你和 NANA 互动得越多——NANA 学得越多——NANA 就会做得越好。`,
        `我再次祝贺 Lions Befrienders 的团队——完成这件有意义的工作。祝各位健康——并度过一个美好的下午。`,
        `非常感谢大家。`,
      ],
      paragraphsEn: [
        `Introduction`,
      ...
      tldr: [
        `NANA（邻里安老智能助理）是 AI 驱动的语音助理——可以自动给乐龄人士打关怀电话，用对方偏好的语言或方言陪聊；通话后向 Lions Befrienders 工作人员提供要点摘要与跟进高亮。`,
        `到 2030 年，每 4 位新加坡人中就有 1 位年满 65 岁——其中又有 1/4 年满 80 岁。在老龄化压力下，新加坡把科技定位为社区护理的「赋能者」，让乐龄长辈能更长时间留在社区。`,
        `NANA 的设计原则是「支持人，而不是替代人」——AI 处理例行关怀电话，员工和义工解放出来专注做唯有人类能做的深度陪伴。`,
        `这是基层创新（ground-up innovation）的样本——Lions Befrienders 多年迭代，让 NANA 更懂得理解和回应新加坡本地乐龄人士；MDDI 期待 NANA 在更广社区中推广。`,
        `政府同时通过 LifeSG App（整合 100+ 项政府服务）向乐龄人士提供幸福感问卷与个性化建议——NANA + LifeSG 一并体现了「让护理向上游延伸」的策略。`,
      ],
      tldrEn: [
        `NANA (Neighbourhood Assistant for Nurturing Ageing) is an AI-powered voice befriender that places automated check-in calls to seniors in their preferred language or dialect, then hands Lions Befrienders staff a summary plus follow-up highlights.`,
        `By 2030, 1 in 4 Singaporeans will be 65+, and 1 in 4 of them 80+. Under that demographic pressure, Singapore is positioning technology as an enabler of community care so seniors can live in the community for as long as possible.`,
        `The framing is 'technology supporting people, not replacing them' — AI handles routine check-ins so staff and volunteers are freed up for the deep companionship only humans can give.`,
        `NANA is held up as a model of ground-up innovation — Lions Befrienders spent years tuning it to understand and respond to local Singaporean seniors; MDDI signals intent to see the approach scale.`,
        `NANA pairs with LifeSG's wellness questionnaire (consolidating 100+ government services) as part of a broader strategy to push care upstream — supporting seniors before anything goes wrong, not just when they are unwell.`,
      ],
      translatedAt: `2026-05-15`,
      translationSource: 'claude',
    },
  'opening-address-by-minister-josephine-teo-at-atxsummit-2026': {
    speechId: `opening-address-by-minister-josephine-teo-at-atxsummit-2026`,
    ...
    tldrEn: [
      `Seventy AI Centres of Excellence have been established in Singapore.`,
      `The National AI Impact Programme aims to enable 10,000 small and medium enterprises to use AI meaningfully.`,
      `Four sectors—Connectivity, Advanced Manufacturing, Healthcare, and Finance—are prioritized for National AI Missions and together represent over 40% of Singapore's gross domestic product.`,
      `Changi Airport's Terminal 5 will increase the airport's annual passenger handling capacity by approximately 50 million passengers.`,
      `Singapore's industrial robot density is approximately five times the global average and ranks consistently among the world's highest.`,
      `The National AI Council, chaired by the Prime Minister, was established to oversee National AI Missions aimed at broadening AI adoption across the economy.`,
    ],
  ...
  'mddi-s-response-to-pq-on-review-of-personal-data-protection-act-2012-to-address-use-of-inferred-or-derived-data-generated-by-ai':
    {
      speechId: `mddi-s-response-to-pq-on-review-of-personal-data-protection-act-2012-to-address-use-of-inferred-or-derived-data-generated-by-ai`,
      sourceUrl: `https://www.mddi.gov.sg/newsroom/mddi-s-response-to-pq-on-review-of-personal-data-protection-act-2012-to-address-use-of-inferred-or-derived-data-generated-by-ai/`,
      sourceLanguage: 'en',
      ...
      tldr: [
        `《个人数据保护法》要求组织保护关于可识别个人的个人数据，包括从这些数据衍生的数据。`,
        `个人数据保护委员会已发布关于在AI推荐和决策系统中使用个人数据的咨询指南。`,
        `指南规定组织应仅出于合法商业目的使用个人数据。`,
        `指南要求将个人数据收集限制在必要的范围内。`,
      ],
      tldrEn: [
        `The Personal Data Protection Act requires organizations to safeguard personal data about identifiable individuals, including data derived from such personal data.`,
        `The Personal Data Protection Commission has published Advisory Guidelines on the Use of Personal Data in AI Recommendation and Decision Systems.`,
        `The guidelines establish that organizations should use personal data only for legitimate business purposes.`,
        `The guidelines require limiting personal data collection to what is necessary.`,
      ],
      translatedAt: `2026-05-21`,
      translationSource: 'claude',
      translationModel: 'haiku',
  ...
  'opening-speech-by-minister-josephine-teo-at-the-international-scientific-exchange-for-ai-safety-2026-main-conference':
    {
      speechId: `opening-speech-by-minister-josephine-teo-at-the-international-scientific-exchange-for-ai-safety-2026-main-conference`,
      sourceUrl: `https://www.mddi.gov.sg/newsroom/opening-speech-by-minister-josephine-teo-at-the-international-scientific-exchange-for-ai-safety-2026-main-conference/`,
      sourceLanguage: 'en',
      fetchedAt: `2026-05-22`,
      source: 'mddi-newsroom',
      paragraphs: [
      ...
      tldrEn: [
        `Singapore's National AI Strategy and AI Missions focus on deploying AI to improve healthcare, transport and logistics, manufacturing, education, and climate resilience.`,
        `Singapore will differentiate as an AI hub by establishing an environment of trust with responsible technology deployment, rather than competing on compute power or capital spending.`,
        `Singapore has introduced AI Verify to encourage responsible AI testing and is launching an accreditation programme for independent third-party AI testers to establish testing standards.`,
        `Singapore is committed to preventing jobless growth through digital literacy and skills training across professions to help workers adapt to AI-driven roles.`,
        `Singapore is building internal government technical expertise to independently assess AI risks and make effective regulatory decisions.`,
        `Singapore will collaborate with like-minded countries on AI governance, standards, and risk management since AI risks do not respect national boundaries.`,
      ],
      translatedAt: `2026-05-21`,
      translationSource: 'claude',
      translationModel: 'haiku',
    },
  'opening-speech-by-mos-rahayu-mahzam-at-the-ai-in-health-x-atxsummit': {
    speechId: `opening-speech-by-mos-rahayu-mahzam-at-the-ai-in-health-x-atxsummit`,
    sourceUrl: `https://www.mddi.gov.sg/newsroom/opening-speech-by-mos-rahayu-mahzam-at-the-ai-in-health-x-atxsummit/`,
    sourceLanguage: 'en',
    fetchedAt: `2026-05-22`,
    source: 'mddi-newsroom',
    paragraphs: [
    ...
    tldrEn: [
      `By 2030, Singapore will have more seniors than children for the first time, with one in four Singaporeans aged 65 or older, driving the need to shift healthcare upstream toward prevention through initiatives like Healthier SG.`,
      `Singapore General Hospital and A*STAR's Diagnostics Development Hub partnership has enabled three innovations: the in-vitro Antibiotic Combination Test (iACT) to address antimicrobial resistance, PENSIEVE-AI for detecting early memory problems in seniors, and HealthVector Diabetes for estimating chronic kidney disease risk in people with type 2 diabetes.`,
      `SingHealth developed the S.C.O.R.E. framework—which assesses Safety, Context & Consensus, Objectivity, Reproducibility, and Explainability—to evaluate large language model outputs and AI-generated responses in clinical settings.`,
      `SingHealth and Gyalpozhing College of Information Technology are co-developing an AI-assisted chest radiograph model trained on Bhutanese data to diagnose lung diseases in rural hospitals, while co-developing guidelines, educational programmes, and regulatory frameworks tailored to Bhutan's context.`,
      `Healthcare is designated as one of Singapore's national AI Missions, supported by government guidance including the AI in Healthcare Guidelines (AIHGle) and Model AI Governance Frameworks to ensure safe and responsible AI deployment.`,
    ],
    translatedAt: `2026-05-22`,
    translationSource: 'claude',
    translationModel: 'haiku',
  },
};
