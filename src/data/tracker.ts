...
export const sections: TrackerSection[] = [
  ...
  },
  {
    icon: '🌐',
    title: '国际治理影响力',
    titleEn: 'International Governance Influence',
    rows: [
      {
    ...
    rows: [
      {
        ...
        nameEn: 'Microsoft AI adoption',
        value: '全球第 2（60.9%，仅次于 UAE 64.0%）',
        valueEn: '#2 globally (60.9%, behind UAE at 64.0%)',
        source: 'Microsoft AI Economy Institute, 2026.1',
        sourceEn: 'Microsoft AI Economy Institute, 2026-01',
        sourceUrl:
      ...
      },
      {
        ...
        nameEn: 'Tortoise Global AI Index',
        value: '第 3 名（仅次于美国、中国）',
        valueEn: '#3 (after US and China)',
        source: 'Tortoise Media, 2024.9',
        sourceEn: 'Tortoise Media, 2024-09',
        sourceUrl: 'https://www.tortoisemedia.com/intelligence/global-ai/',
      },
      {
        name: 'Oxford 政府 AI 就绪度',
        nameEn: 'Oxford Government AI Readiness',
        value: '第 2 名（仅次于美国）',
        valueEn: '#2 (after the US)',
        source: 'Oxford Insights, 2024.12',
        sourceEn: 'Oxford Insights, 2024-12',
        sourceUrl: 'https://oxfordinsights.com/ai-readiness/ai-readiness-index/',
      },
      {
        name: 'WIPO 全球创新指数',
        nameEn: 'WIPO Global Innovation Index',
        value: '第 5 名',
        valueEn: '#5',
        source: 'WIPO, 2025',
        sourceEn: 'WIPO, 2025',
      ...
      {
        name: 'AI 基础设施子项',
        nameEn: 'AI infrastructure sub-index',
        value: '第 2 名（仅次于美国）',
        valueEn: '#2 (after the US)',
        source: 'Tortoise, 2024',
        sourceEn: 'Tortoise, 2024',
        sourceUrl: 'https://www.tortoisemedia.com/intelligence/global-ai/',
      },
      {
        name: '东南亚深科技融资份额',
