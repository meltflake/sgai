...
export const dimensions: Dimension[] = [
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: 'US$1.9B（累计，Tracxn 口径）',
        valueKo: 'US$1.9B(누적, Tracxn 기준)',
        valueJa: 'US$1.9B（累計、Tracxn ベース）',
        valueEn: 'US$1.9B (cumulative, per Tracxn)',
        source: 'Tracxn, 2026.5',
        sourceEn: 'Tracxn, 2026-05',
        sourceUrl:
  ...
  },
  {
    ...
    metrics: [
      ...
      // adoption cut available (the three vendor datasets are country-level).
      {
        ...
        // asOfDate: '2025-10' — uncomment after P0 merges (MetricRow.asOfDate lands there)
      },
      {
        name: 'AI 工具形态',
      ...
      },
      {
        ...
        nameJa: 'AI スタートアップ企業',
        nameEn: 'AI startups',
        value: '548 家（占东南亚 AI 融资约 57%）',
        valueKo: '548개(동남아 AI 펀딩의 약 57%)',
        valueJa: '548 社（東南アジア AI 融資の約 57%）',
        valueEn: '548 (~57% of Southeast Asia AI funding)',
        source: 'Tracxn 2026.5 / e-Conomy SEA 2025',
        sourceEn: 'Tracxn 2026-05 / e-Conomy SEA 2025',
        sourceUrl:
          'https://tracxn.com/d/artificial-intelligence/ai-startups-in-singapore/__YBFhVmcmOHEexm4oJQjCpjL_x5V8m4mhfvfBLMMT4pI',
        category: '企业采用',
        categoryKo: '기업 채택',
