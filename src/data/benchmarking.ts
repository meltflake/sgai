  ...
  },
  {
    ...
    drilldownEnrichments: {
      ...
      'initiative-2': {
        ...
        analysisKo:
          'MBZUAI(Mohamed bin Zayed University of Artificial Intelligence)는 2019년 아부다비 정부에 의해 설립되었으며, AI를 단일 학과로 하는 세계 최초의 연구형 대학입니다. 기계 학습, 자연어 처리, 컴퓨터 비전 3개의 PhD/Master 프로그램을 제공하며, 학비는 무료이고 장학금을 제공합니다. 교수진은 CMU, MIT, UCL, 칭화 등에서 영입했습니다. 2025년 기준, 글로벌 AI/ML 학술 순위는 상위 20-30위대에 진입했습니다. 판단: MBZUAI는 UAE 「AI 주권」 서사의 가장 구체적인 자산입니다. 4-5년 만에 영(零)에서 글로벌 상위 30위로 진출한 것은 막대한 자본 투입 + 국제 인재 조합의 결과입니다. 하지만 학술 영향력의 「견고성」(최고급 학술대회 논문 / 인용도 / 동문 영향력)은 Stanford / MIT의 수십 년 축적과 비교할 수 없습니다. UAE는 학문적 깊이에서 여전히 「돈으로 진도 구매」 상태입니다.',
        analysisJa:
  ...
  },
  {
    ...
    drilldownEnrichments: {
      ...
      'initiative-1': {
        ...
        analysisKo:
          'Mila(Montreal Learning Algorithms Institute)는 1993년 Yoshua Bengio에 의해 몬트리올 대학교에서 설립되었으며, 현재 전 세계 최대 규모 학술 AI 연구소 중 하나입니다 — 약 1200명의 연구원을 가지고 있으며, 심층 학습, 강화 학습, AI4Science, AI 안전을 다룹니다. 자금: CIFAR Pan-Canadian AI Strategy CAD $2000만(2단계), 퀘벡 주 CAD $4000만+, 기업 협력(Google, Meta, Samsung). Bengio는 Mila의 과학 이사이며 图灵상 수상자입니다. 판단: Mila는 인원 규모로는 전 세계 최대 심층 학습 연구소입니다 — 하지만 상업화 기록은 Stanford / MIT보다 명확히 약합니다. 도전은 Mila 연구 깊이를 캐나다 경제 가치로 전환하는 것이며, 졸업생이 미국 기술 대기업으로 이동하지 않도록 하는 것입니다.',
        analysisJa:
