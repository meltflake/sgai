    ...
    items: [
      {
        ...
        scope: 'governance',
        status: '提案',
        summary: '这是新加坡法令在线的一个目录页面，列出了新加坡所有现行法律（523项，分27页）。页面提供了按字母顺序浏览各类法令的功能，包括会计师法、医疗指令法、仲裁法等多个领域的法律文本下载。该资源由新加坡律政部立法处维护。',
        summaryEn: 'This is a directory page on Singapore Statutes Online listing all current Acts in Singapore (523 items across 27 pages). The page provides alphabetical browsing of legislation across multiple domains, including the Accountants Act, Advance Medical Directive Act, and Arbitration Act, with downloadable PDF texts. The resource is maintained by the Legislation Division of the Attorney-General\'s Chambers of Singapore.',
        body: `这是新加坡法令在线的一个目录页面，列出了新加坡所有现行法律（523项，分27页）。页面提供了按字母顺序浏览各类法令的功能，包括会计师法、医疗指令法、仲裁法等多个领域的法律文本下载。该资源由新加坡律政部立法处维护。`,
        bodyEn: `This is a directory page on Singapore Statutes Online listing all current Acts in Singapore (523 items across 27 pages). The page provides alphabetical browsing of legislation across multiple domains, including the Accountants Act, Advance Medical Directive Act, and Arbitration Act, with downloadable PDF texts. The resource is maintained by the Legislation Division of the Attorney-General's Chambers of Singapore.`,
        sourceUrl: 'https://sso.agc.gov.sg/Browse/Act/Current',
      },
      {
        title: '新加坡法定法令在线 - 浏览已废除/失效法案 - 全部',
        ...
        scope: 'governance',
        status: '提案',
        summary: '这是新加坡法定法令在线平台上关于已废除或失效法案的浏览页面。页面列出了295项已被废除或失效的法案，包括《会计师法》《收养儿童法1939年》《农业害虫法》《仲裁法》《建筑师法》等多个历史法案。该页面提供了按标题排序、筛选和分页浏览功能，由新加坡总检察长室法律部门维护。',
        summaryEn: 'This is a directory page on Singapore Statutes Online listing repealed and spent Acts. It displays 295 historical legislation items across 15 pages, including the Accountants Act, Adoption of Children Act 1939, Agricultural Pests Act, Arbitration Act, Architects Act, and others. The page provides browsing, filtering, and sorting features, maintained by the Legislation Division of Singapore\'s Attorney-General\'s Chambers.',
        body: `这是新加坡法定法令在线平台上关于已废除或失效法案的浏览页面。页面列出了295项已被废除或失效的法案，包括《会计师法》《收养儿童法1939年》《农业害虫法》《仲裁法》《建筑师法》等多个历史法案。该页面提供了按标题排序、筛选和分页浏览功能，由新加坡总检察长室法律部门维护。`,
        bodyEn: `This is a directory page on Singapore Statutes Online listing repealed and spent Acts. It displays 295 historical legislation items across 15 pages, including the Accountants Act, Adoption of Children Act 1939, Agricultural Pests Act, Arbitration Act, Architects Act, and others. The page provides browsing, filtering, and sorting features, maintained by the Legislation Division of Singapore's Attorney-General's Chambers.`,
        sourceUrl: 'https://sso.agc.gov.sg/Browse/Act/Repealed',
      },
      {
        title: '新加坡未生效法案浏览 - 全部 - 新加坡法规在线',
        ...
        scope: 'governance',
        status: '提案',
        summary: '本页面列出新加坡12项未生效的法案，包括2024年至2026年颁布的立法。涵盖范围广泛，包括ACRA监管增强、反洗钱、沿海保护、电子产权转让、健康信息保护、种族和谐维护、在线安全、融资扩散预防、国际商业法庭、社会住宅、职场公平等多个领域。',
        summaryEn: 'This page lists 12 uncommenced acts from Singapore\'s statutes, spanning 2024 to 2026. Legislative areas covered include ACRA regulatory enhancements, anti-money laundering, coastal protection, electronic conveyancing, health information, maintenance of racial harmony, online safety, prevention of proliferation financing, international commercial courts, social residential homes, and workplace fairness.',
        body: `本页面列出新加坡12项未生效的法案，包括2024年至2026年颁布的立法。涵盖范围广泛，包括ACRA监管增强、反洗钱、沿海保护、电子产权转让、健康信息保护、种族和谐维护、在线安全、融资扩散预防、国际商业法庭、社会住宅、职场公平等多个领域。`,
        bodyEn: `This page lists 12 uncommenced acts from Singapore's statutes, spanning 2024 to 2026. Legislative areas covered include ACRA regulatory enhancements, anti-money laundering, coastal protection, electronic conveyancing, health information, maintenance of racial harmony, online safety, prevention of proliferation financing, international commercial courts, social residential homes, and workplace fairness.`,
        sourceUrl: 'https://sso.agc.gov.sg/Browse/Act/Uncommenced',
      },
      {
        title: '浏览法案补编 - 全部 - 新加坡法规在线',
        titleEn: 'Browse Acts Supplement - All - Singapore Statutes Online',
        date: '2026-05',
        authority: 'Auto: 待审核',
        authorityEn: 'Auto: pending review',
        scope: 'governance',
        status: '提案',
        summary: '这是新加坡律政部网站上的法案补编浏览页面，列出了1980年至2026年间发布的所有法案补编，共1520项。页面提供了按年份筛选和排序功能，以及PDF下载链接。最近的法案补编包括2026年的《健康信息法》和《沿海保护及其他修订法》等。',
        summaryEn: 'This is a Singapore Attorney-General\'s Chambers webpage that provides a browse interface for Acts Supplements (amendments to legislation) published between 1980 and 2026, containing 1,520 total items. The page offers filtering by year and sorting options, with downloadable PDFs for each supplement. Recent supplements from 2026 include the Health Information Act and the Coastal Protection and Other Amendments Act.',
        body: `这是新加坡律政部网站上的法案补编浏览页面，列出了1980年至2026年间发布的所有法案补编，共1520项。页面提供了按年份筛选和排序功能，以及PDF下载链接。最近的法案补编包括2026年的《健康信息法》和《沿海保护及其他修订法》等。`,
        bodyEn: `This is a Singapore Attorney-General's Chambers webpage that provides a browse interface for Acts Supplements (amendments to legislation) published between 1980 and 2026, containing 1,520 total items. The page offers filtering by year and sorting options, with downloadable PDFs for each supplement. Recent supplements from 2026 include the Health Information Act and the Coastal Protection and Other Amendments Act.`,
        sourceUrl: 'https://sso.agc.gov.sg/Browse/Acts-Supp',
      },
      {
        title: '浏览议案增刊 - 新加坡法令在线',
        titleEn: 'Browse Bills Supplement - Singapore Statutes Online',
        date: '2026-05',
        authority: 'Auto: 待审核',
        authorityEn: 'Auto: pending review',
        scope: 'governance',
        status: '提案',
        summary: '新加坡法令在线官方门户网站中的议案增刊浏览页面。该页面提供了自1961年以来按年份组织的所有议案增刊的完整列表，包括2026年的最新议案（如中央公积金修正案、沿海防护修正案等13项议案）和2025年的往年议案。用户可按年份、标题等条件筛选和下载议案的PDF文件。',
        summaryEn: 'Official Singapore Statutes Online portal page for browsing Bills Supplement. The page provides a comprehensive chronological listing of all Bills Supplements from 1961 onwards, organized by year. It includes 2026 legislation (13 bills such as Central Provident Fund Amendment, Coastal Protection Amendment) and prior years\' bills, with filtering and PDF download capabilities.',
        body: `新加坡法令在线官方门户网站中的议案增刊浏览页面。该页面提供了自1961年以来按年份组织的所有议案增刊的完整列表，包括2026年的最新议案（如中央公积金修正案、沿海防护修正案等13项议案）和2025年的往年议案。用户可按年份、标题等条件筛选和下载议案的PDF文件。`,
        bodyEn: `Official Singapore Statutes Online portal page for browsing Bills Supplement. The page provides a comprehensive chronological listing of all Bills Supplements from 1961 onwards, organized by year. It includes 2026 legislation (13 bills such as Central Provident Fund Amendment, Coastal Protection Amendment) and prior years' bills, with filtering and PDF download capabilities.`,
        sourceUrl: 'https://sso.agc.gov.sg/Browse/Bills-Supp',
      },
    ],
  },
];
