...
export const sections: LegalSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: '刑事法（杂项修正）法 2025',
        topicIds: ['governance-regulation', 'deepfakes-disinformation'],
        titleKo: '형사법(잡항 개정) 법 2025',
        titleJa: '刑事法（雑則改正）法 2025',
        titleEn: 'Criminal Law (Miscellaneous Amendments) Act 2025',
        date: '2025-11 通过，AI 相关条款 2026-08-17 生效',
        dateEn: 'Passed 2025-11; AI provisions in force 2026-08-17',
        dateJa: '2025-11 可決、AI 関連条項は 2026-08-17 施行',
        dateKo: '2025-11 통과, AI 관련 조항 2026-08-17 시행',
        authority: 'MHA',
        authorityEn: 'Ministry of Home Affairs (MHA)',
        authorityUrl: 'https://www.mha.gov.sg/',
        scope: 'output',
        ...
        body: '2025 年的 Criminal Law 修正案明确把 AI 生成的私密图像（裸露、性图像）和儿童性剥削图像纳入刑法。创新点：(1) 即便图像中的"人"是虚构的（AI 生成而非真实人物），如果看起来像未成年人，依然入刑；(2) 制作、持有、传播均构成犯罪；(3) 加重刑罚针对针对实名个人的深伪私密图像。这填补了"AI 生成不存在的人"这种新型情形的法律空白。法案 2025 年 11 月 4 日国会三读通过，分阶段生效：诈骗类刑罚条款 2025 年 12 月 30 日先行，私密图像与 AI 相关条款 2026 年 8 月 17 日起生效；未经同意制作私密图像（含 AI 生成）最高监禁两年、罚款或两者并罚，对象是 14 岁以下未成年人时监禁为强制刑。',
        sourceUrl:
          'https://www.mha.gov.sg/media-room/newsroom/commencement-of-the-criminal-law-miscellaneous-amendments-act-2025/',
        bodyKo:
          '2025년의 형법 수정안은 AI 생성 비밀 이미지(나신, 성 이미지)와 아동 성적 착취 이미지를 형법에 포함시킵니다. 혁신 포인트: (1) 이미지 내 「사람」이 가상이라도(AI 생성이며 실제 인물 아님), 미성년자처럼 보이면 여전히 형벌의 대상입니다. (2) 제작, 소유, 전파 모두 범죄를 구성합니다. (3) 실명 개인을 겨냥한 딥페이크 비밀 이미지에 대해 강화된 형벌을 적용합니다. 이는 「AI 생성 존재하지 않는 사람」이라는 새로운 상황의 법적 공백을 채웁니다. 법안은 2025년 11월 4일 국회를 통과했고 단계적으로 시행됩니다. 사기 관련 형벌 조항은 2025년 12월 30일에 먼저, 사적 이미지와 AI 관련 조항은 2026년 8월 17일부터 시행됩니다. 동의 없이 사적 이미지(AI 생성 포함)를 제작하면 최대 2년 징역, 벌금 또는 병과이며, 대상이 14세 미만이면 징역이 필수형입니다.',
        bodyJa:
          '2025年の刑法修正案は、AI生成の私密画像（裸露、性画像）と児童性搾取画像を刑法に明確に組み込みます。革新的なポイント：(1) 画像の「人」が虚構の（AI生成で実在しない人物）である場合でも、未成年者に見える場合、依然として犯罪です；(2) 製作、所持、配布はすべて犯罪を構成します；(3) 実名個人を対象とした深伪私密画像に対する刑罰を加重します。これは「AI生成で存在しない人」というこのような新しい状況の法律空白を埋めます。法案は 2025 年 11 月 4 日に国会で可決され、段階的に施行されます。詐欺関連の刑罰条項は 2025 年 12 月 30 日に先行し、私密画像と AI 関連条項は 2026 年 8 月 17 日に施行されました。同意なく私密画像（AI 生成を含む）を製作した場合、最長 2 年の禁錮、罰金、またはその両方が科され、対象が 14 歳未満の場合は禁錮が必須刑となります。',
        bodyEn:
          'The 2025 Criminal Law amendments expressly bring AI-generated intimate imagery (nudity, sexual imagery) and child sexual exploitation material into the criminal code. Notable innovations: (1) even where the "person" in the image is fictitious (AI-generated rather than a real individual), the offence still applies if the depicted person appears to be a minor; (2) production, possession and distribution all constitute offences; (3) aggravated penalties apply to deepfake intimate imagery targeting identifiable individuals. The amendment closes the legal gap for the new category of "AI-generated non-existent persons". Parliament passed the Bill on 4 November 2025 and the Act commenced in phases: the scam-penalty provisions on 30 December 2025, and the intimate-image and AI provisions on 17 August 2026. Producing an intimate image without consent (including AI-generated material) carries up to two years\' imprisonment, a fine, or both, with mandatory imprisonment where the subject is under 14.',
      },
      {
        title: '网络安全（救济与问责）法 2025',
        topicIds: ['governance-regulation', 'safety-ethics'],
        titleKo: '온라인 안전(구제 및 책임) 법 2025',
        titleJa: 'オンライン安全（救済と説明責任）法 2025',
        titleEn: 'Online Safety (Relief and Accountability) Act 2025',
        date: '2025-11 通过，2026-06-29 生效',
        dateEn: 'Passed 2025-11, in force 2026-06-29',
        dateJa: '2025-11 可決、2026-06-29 施行',
        dateKo: '2025-11 통과, 2026-06-29 시행',
        authority: 'MDDI',
        ...
        body: '2025 年通过的 Online Safety 新法，重点是受害者救济与平台问责：(1) 受害者可向 Online Safety Commission（OSC）提交投诉，平台 24 小时内须处理；(2) 平台未履行义务可面临高额罚款；(3) AI 生成的诽谤、骚扰、性图像均覆盖。这是新加坡输出侧治理从"事后惩罚"转向"过程问责"的关键一步。法案 2025 年 11 月 5 日国会通过，网络安全委员会（OSC）与法定侵权条款 2026 年 6 月 29 日起生效，覆盖 13 类网络伤害。',
        sourceUrl:
          'https://www.mddi.gov.sg/newsroom/online-safety-commission-and-online-safety--relief-and-accountability--act-2025-to-start-on-29-june-2026/',
        bodyKo:
          '2025년 통과된 온라인 안전 신법은 피해자 구제와 플랫폼 책임에 중점을 두고 있습니다: (1) 피해자는 Online Safety Commission(OSC)에 불만을 제출할 수 있으며, 플랫폼은 24시간 내에 처리해야 합니다. (2) 플랫폼이 의무를 이행하지 않으면 높은 벌금에 직면할 수 있습니다. (3) AI 생성 명예 훼손, 괴롭힘, 성 이미지 모두 포함됩니다. 이는 싱가포르 출력 측면 치리가 「사후 처벌」에서 「과정 책임」으로 전환하는 핵심 단계입니다. 법안은 2025년 11월 5일 국회를 통과했고, Online Safety Commission(OSC)과 법정 불법행위 조항은 2026년 6월 29일부터 시행되어 13개 유형의 온라인 피해를 다룹니다.',
        bodyJa:
          '2025年に可決されたOnline Safety新法は、被害者救済とプラットフォーム問責に重点を置いています：(1) 被害者はOnline Safety Commission（OSC）に苦情を提出でき、プラットフォームは24時間以内に処理する必要があります；(2) プラットフォームが義務を果たさない場合、高額の罰金に直面する可能性があります；(3) AI生成の名誉毀損、嫌がらせ、性画像はすべて対象です。これはシンガポールの出力側治理が「事後的罰」から「プロセス問責」への転換の重要なステップです。法案は 2025 年 11 月 5 日に国会で可決され、Online Safety Commission（OSC）と法定不法行為条項は 2026 年 6 月 29 日に施行され、13 種類のオンライン被害を対象とします。',
        bodyEn:
          "The 2025 Online Safety Act focuses on victim relief and platform accountability: (1) victims may file complaints with the Online Safety Commission (OSC), which platforms must act on within 24 hours; (2) platforms that fail to comply face significant fines; (3) AI-generated defamation, harassment and sexual imagery all fall within scope. This marks a key step in Singapore's output-side governance shifting from after-the-fact punishment to in-process accountability. Parliament passed the Bill on 5 November 2025; the Online Safety Commission (OSC) and the statutory tort provisions commenced on 29 June 2026, covering 13 categories of online harms.",
      },
    ],
  },
  {
