...
This is not just a regional-HQ story. It connects OpenAI’s deployment engineering capacity into Singapore’s NAIS / NAIC execution pipeline. For sgai.md, it belongs in the May 2026 strategy refresh as a node combining foreign frontier capability, local talent, and enterprise adoption.`,
      ...
      },
      {
        ...
        relatedDebateIds: [
          ...
          'oral-answer-4023',
          'oral-answer-4013',
          'written-answer-20819',
          'written-answer-20821',
          'written-answer-20835',
          'budget-2610',
          'budget-2605',
          'budget-2585',
          'budget-2361',
      ...
      },
      {
        ...
        relatedDebateIds: [
          ...
          'budget-2916',
          'oral-answer-4023',
          'written-answer-21904',
          'written-answer-21161',
          'oral-answer-3927',
          'written-answer-19554',
          'budget-2620',
          'budget-2605',
          'budget-2583',
          'written-answer-18417',
          'written-answer-18326',
          'written-answer-17376',
          ...
          'budget-2346',
          'budget-2336',
          'written-answer-15541',
          'written-answer-15542',
          'motion-2296',
          'oral-answer-3393',
          'written-answer-15270',
          'written-answer-15269',
          'written-answer-15268',
          'oral-answer-3383',
          'written-answer-15158',
          'oral-answer-3375',
          'written-answer-14629',
          'written-answer-13935',
          'oral-answer-3295',
          'written-answer-13437',
          'budget-2054',
          'written-answer-9674',
          'written-answer-9318',
          'written-answer-8049',
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['budget-2915', 'budget-2914', 'budget-2363', 'oral-answer-3375'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['budget-2934', 'budget-2362', 'budget-2325', 'budget-2072', 'cos-mddi-2026'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
...
Strategically, this moves AI Verify from tools and frameworks into market infrastructure. Enterprises will not have to rely only on vendor self-testing; they can procure recognised third-party AI assurance services. It fills the accreditation and service-market layer after Singapore’s principles, tools, and sandboxes.`,
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['oral-answer-3193'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['oral-answer-3551', 'oral-answer-3225'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['oral-answer-3852', 'oral-answer-1504'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
...
**Why this matters for AI watchers.** Singapore's consistent approach is to avoid a horizontal AI act and instead bring AI under existing sector statutes. The DIB is that methodology applied at the compute layer: it says nothing about models or training, yet by licensing data centres and cloud services it pulls the security, resilience and energy footprint of AI infrastructure into regulatory view. It also answers repeated parliamentary questions on one-north AI park energy consumption and AI's energy footprint — where the government's answer has consistently been that the regulatory centre of gravity sits at the infrastructure layer, not the model layer.`,
      ...
      },
      {
        ...
        ministry: 'MOH',
        authorPersonIds: [],
        relatedDebateIds: ['cos-moh-2026', 'budget-2918', 'motion-2194', 'motion-2190', 'oral-answer-1504'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
      ...
      },
      {
        ...
        ministry: 'MOT',
        authorPersonIds: [],
        relatedDebateIds: ['oral-answer-1504'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
...
The addendum covers three things: identifying and assessing risk according to agent capabilities, including mapping workflows to surface exploitable weak points; practical controls across the development lifecycle, with examples for different levels of autonomy; and worked scenarios such as app development assistants, automated client onboarding, and automated fraud detection.`,
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['written-answer-21309', 'budget-2328', 'oral-answer-3240', 'budget-1313'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
    ...
    policies: [
      ...
      },
      {
        ...
        relatedDebateIds: [
          ...
          'budget-2593',
          'budget-2570',
          'written-answer-18677',
          'oral-answer-3738',
          'written-answer-17278',
          'budget-2361',
          'oral-answer-3375',
          'budget-1862',
          'budget-1306',
...
Natasha Crampton: "Through this partnership with IMDA, we can combine government insight with Microsoft's technical and operational experience to strengthen AI evaluation."`,
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['motion-2294', 'motion-2296'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
...
This remains one of Singapore’s most important international governance levers. Its leverage is not the number of signatures; it is the ability to put academia, industry, and government onto the same technical problem list.`,
      ...
      },
      {
        ...
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: ['budget-2338', 'budget-2325', 'written-answer-5800'],
        relatedLeverNumbers: [],
        relatedTimelineYears: [],
        relatedPostSlugs: [],
      },
