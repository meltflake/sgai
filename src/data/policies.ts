...
export const categories: PolicyCategory[] = [
  {
    ...
    policies: [
      ...
      {
        id: 'smart-nation-ambassadors',
        title: '智慧国大使计划',
        titleEn: 'Smart Nation Ambassadors',
        date: '2025-02',
        source: '智慧国家与数字政府办公室 (SNDGO)',
        sourceOrgUrl: 'https://www.smartnation.gov.sg/',
        sourceUrl:
          'https://www.smartnation.gov.sg/citizen-engagement/engagement-programmes/smart-nation-ambassadors/',
        summary: '智慧国大使（SNA）计划由新加坡政府于2019年1月启动，截至2023年7月已有超过4,700名志愿者参与，致力于帮助社区接纳数字技术。大使来自各行各业，包括理工学院学生、退休人士、学者和技术专家，通过在路演中分享政府数字工具使用技巧、主持网络研讨会和收集用户反馈等多种方式贡献力量。该计划不要求志愿者具备深厚的技术背景，政府会提供必要培训，欢迎有热情的公众通过volunteer.gov.sg报名参与。',
        content: `智慧国大使（SNA）计划由新加坡政府于2019年1月启动，截至2023年7月已有超过4,700名志愿者参与，致力于帮助社区接纳数字技术。大使来自各行各业，包括理工学院学生、退休人士、学者和技术专家，通过在路演中分享政府数字工具使用技巧、主持网络研讨会和收集用户反馈等多种方式贡献力量。该计划不要求志愿者具备深厚的技术背景，政府会提供必要培训，欢迎有热情的公众通过volunteer.gov.sg报名参与。`,
        summaryEn:
          'The Smart Nation Ambassadors (SNA) programme, launched by Singapore\'s government in January 2019, has recruited over 4,700 volunteers as of July 2023 to help the community embrace digital technologies. Ambassadors come from diverse backgrounds including polytechnic students, retirees, academics, and technology professionals, contributing through activities such as sharing tips on government digital tools at roadshows, facilitating webinars on apps, and gathering user feedback on digital products. The programme does not require participants to have advanced technical skills, as training is provided; interested volunteers can sign up through volunteer.gov.sg.',
        contentEn: `The Smart Nation Ambassadors (SNA) programme, launched by Singapore's government in January 2019, has recruited over 4,700 volunteers as of July 2023 to help the community embrace digital technologies. Ambassadors come from diverse backgrounds including polytechnic students, retirees, academics, and technology professionals, contributing through activities such as sharing tips on government digital tools at roadshows, facilitating webinars on apps, and gathering user feedback on digital products. The programme does not require participants to have advanced technical skills, as training is provided; interested volunteers can sign up through volunteer.gov.sg.`,
        sourceEn: 'Smart Nation and Digital Government Office (SNDGO)',
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: [],
      ...
      {
        id: 'smart-nation-engagement-programmes',
        title: '智慧国家市民参与计划',
        titleEn: 'Smart Nation Engagement Programmes',
        date: '2025-04',
        source: '智慧国家与数字政府办公室 (SNDGO)',
        sourceOrgUrl: 'https://www.smartnation.gov.sg/',
        sourceUrl:
          'https://www.smartnation.gov.sg/citizen-engagement/engagement-programmes/smart-nation-engagement-programmes/',
        summary: '新加坡推出多项市民参与计划，包括IMDA数字融入运动、GovTech科技卡基社区、OGP构建美好黑客马拉松、OGP开放集结计划、智慧国家大使计划和市民共创小组，旨在加强数字包容性，让市民参与设计和测试数字产品，并协助推广数字工具的使用。',
        content: `新加坡推出多项市民参与计划，包括IMDA数字融入运动、GovTech科技卡基社区、OGP构建美好黑客马拉松、OGP开放集结计划、智慧国家大使计划和市民共创小组，旨在加强数字包容性，让市民参与设计和测试数字产品，并协助推广数字工具的使用。`,
        summaryEn:
          'Singapore launched multiple citizen engagement programmes including IMDA\'s Digital for Life Movement, GovTech\'s Tech Kaki Community, OGP\'s Build for Good Hackathon, OGP\'s Open Jio Programme, Smart Nation Ambassador Programme, and SNA Citizen Co-Creation Group. These initiatives aim to strengthen digital inclusion, involve citizens in shaping digital products and services, and promote the use of digital tools across the community.',
        contentEn: `Singapore launched multiple citizen engagement programmes including IMDA's Digital for Life Movement, GovTech's Tech Kaki Community, OGP's Build for Good Hackathon, OGP's Open Jio Programme, Smart Nation Ambassador Programme, and SNA Citizen Co-Creation Group. These initiatives aim to strengthen digital inclusion, involve citizens in shaping digital products and services, and promote the use of digital tools across the community.`,
        sourceEn: 'Smart Nation and Digital Government Office (SNDGO)',
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: [],
      ...
      {
        id: 'smart-nation-cityscape-exhibition',
        title: '智慧城市展览',
        titleEn: 'Smart Nation CityScape Exhibition',
        date: '2025-02',
        source: '智慧国家与数字政府办公室 (SNDGO)',
        sourceOrgUrl: 'https://www.smartnation.gov.sg/',
        sourceUrl:
          'https://www.smartnation.gov.sg/citizen-engagement/showcases/smart-nation-cityscape/',
        summary: '新加坡推出的智慧城市展览，位于规划署中心，整合了新加坡城市展览馆。展览通过互动式展品和展示，向访客展示数字技术如何驱动城市规划、基础设施建设、吸引科技人才，以及新加坡在智慧城市创新中的领导地位。访客可以探索新加坡智慧国进展的历史演进、了解嵌入城市基础设施中的科技应用、以及体验政府数字化服务。',
        content: `新加坡推出的智慧城市展览，位于规划署中心，整合了新加坡城市展览馆。展览通过互动式展品和展示，向访客展示数字技术如何驱动城市规划、基础设施建设、吸引科技人才，以及新加坡在智慧城市创新中的领导地位。访客可以探索新加坡智慧国进展的历史演进、了解嵌入城市基础设施中的科技应用、以及体验政府数字化服务。`,
        summaryEn:
          'Singapore\'s Smart Nation CityScape is an exhibition integrated with the Singapore City Gallery at the URA Centre, designed to educate visitors about digital technology\'s role in powering the city and daily life. Through interactive exhibits and displays, visitors discover how technology supports urban planning, infrastructure, business, and talent attraction, establishing Singapore as a thought leader in Smart City innovation. The exhibition features historical journeys through Singapore\'s Smart Nation evolution, explores embedded technologies, and allows visitors to explore government digital services.',
        contentEn: `Singapore's Smart Nation CityScape is an exhibition integrated with the Singapore City Gallery at the URA Centre, designed to educate visitors about digital technology's role in powering the city and daily life. Through interactive exhibits and displays, visitors discover how technology supports urban planning, infrastructure, business, and talent attraction, establishing Singapore as a thought leader in Smart City innovation. The exhibition features historical journeys through Singapore's Smart Nation evolution, explores embedded technologies, and allows visitors to explore government digital services.`,
        sourceEn: 'Smart Nation and Digital Government Office (SNDGO)',
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: [],
      ...
      {
        id: 'smart-nation-showcases',
        title: '智慧国家展示',
        titleEn: 'Smart Nation showcases',
        date: '2025-04',
        source: '智慧国家与数字政府办公室 (SNDGO)',
        sourceOrgUrl: 'https://www.smartnation.gov.sg/',
        sourceUrl:
          'https://www.smartnation.gov.sg/citizen-engagement/showcases/smart-nation-showcases/',
        summary: '新加坡智慧国家计划提供多个展示平台，供公众了解智慧国家倡议。其中包括智慧国家城市景观展览，展示智慧国家计划如何融入城市，以及位于科学中心的智慧国家游乐景观，以简单易懂的方式向公众介绍科技趋势。',
        content: `新加坡智慧国家计划提供多个展示平台，供公众了解智慧国家倡议。其中包括智慧国家城市景观展览，展示智慧国家计划如何融入城市，以及位于科学中心的智慧国家游乐景观，以简单易懂的方式向公众介绍科技趋势。`,
        summaryEn:
          'Singapore\'s Smart Nation programme features multiple showcases where the public can learn about Smart Nation initiatives. These include Smart Nation CityScape, an informational exhibition demonstrating how Smart Nation initiatives are embedded in the city, and Smart Nation PlayScape at the Science Centre, which educates the public on tech trends in a simple and accessible manner.',
        contentEn: `Singapore's Smart Nation programme features multiple showcases where the public can learn about Smart Nation initiatives. These include Smart Nation CityScape, an informational exhibition demonstrating how Smart Nation initiatives are embedded in the city, and Smart Nation PlayScape at the Science Centre, which educates the public on tech trends in a simple and accessible manner.`,
        sourceEn: 'Smart Nation and Digital Government Office (SNDGO)',
        ministry: undefined,
        authorPersonIds: [],
        relatedDebateIds: [],
