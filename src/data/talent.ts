...
export const programmes: TalentProgramme[] = [
  {
    ...
    highlightsJa: ['3 ヶ月の深度訓練', '3 または 6 ヶ月の実プロジェクト', '2 段階の技術選抜', 'Batch 24/25 申請期開放'],
    highlightsKo: ['3개월 심화 교육', '3 또는 6개월 실제 프로젝트', '2단계 기술 선발', 'Batch 24/25 신청 기간 개방'],
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            'フルタイムプロジェクトで、オフラインでの投入が必要です。',
            '技術評価は 6 日間の take-home と面接を含みます。',
            '卒業後の一般的なキャリア方向には、AI Engineer、MLOps Engineer、Data Scientist が含まれます。',
          ],
          bulletsKo: [
            '풀타임 프로젝트로, 오프라인 투입이 필요합니다',
            '기술 평가는 6일간의 take-home과 면접을 포함합니다',
            '졸업 후 일반적인 진로로는 AI Engineer, MLOps Engineer, Data Scientist 등이 있습니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsJa: [
      '4 週間の自学習 + 12 週間のプロジェクト',
      '企業が持ち込む問題陳述',
      'Prompt Engineering / RAG / Agent',
      'Intake 10 は Q2 2026 に開放予定',
    ],
    highlightsKo: [
      '4주 독학 + 12주 프로젝트',
      '기업 제공 문제 진술',
      'Prompt Engineering / RAG / Agent',
      'Intake 10 Q2 2026 개방 예정',
    ],
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            '1 クラスあたり最大 20 名の学員です。',
            'プロジェクトコンサルテーションは少なくとも 6 回、各回最大 2 時間です。',
            'アプリケーションは通常、企業独自のクラウドプラットフォームまたは内部承認プラットフォームが必要です。',
          ],
          bulletsKo: [
            '각 반의 최대 정원은 20명입니다',
            '프로젝트 상담은 최소 6회, 회당 최대 2시간입니다',
            '응용은 일반적으로 기업의 자체 클라우드 플랫폼 또는 내부 승인 플랫폼이 필요합니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsJa: [
      ...
      '大学推薦制',
      '学費全額サポート',
      'トップカンファレンス/トップジャーナルレベルの研究成果が必須',
    ],
    highlightsKo: [
      'NUS / NTU / SMU / SUTD',
      '대학 추천 제도',
      '전액 학비 지원',
      '최상위 학회/저널 수준의 연구 산출물 요구',
    ],
    status: '2026 提名已截止',
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            'すべての国籍からの申請をお勧めします。',
            'シンガポール市民、永住者、およびアセアン申請者が特に奨励されます。',
            '研究期間中は他の AISG プロジェクトに参加できます。',
          ],
          bulletsKo: [
            '모든 국적의 신청을 장려합니다',
            '싱가포르 시민, 영구 거주자 및 ASEAN 신청자는 특히 장려됩니다',
            '연구 기간 동안 AISG의 다른 프로젝트에 참여할 수 있습니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsJa: ['学部倒数第二年の申請', '研究型修士', '大学推薦制', '修士課程学費全額サポート'],
    highlightsKo: ['학부 마지막에서 두 번째 해 신청', '연구형 석사', '대학 추천 제도', '전액 석사 학비 지원'],
    status: '下一轮待公布',
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            'シンガポール市民のみです。',
            '明確な研究関心が必要です。',
            '研究テーマは AISG PhD Fellowship と似ています。',
          ],
          bulletsKo: [
            '싱가포르 시민만 해당합니다',
            '명확한 연구 관심 분야를 요구합니다',
            '연구 주제는 AISG PhD Fellowship과 유사해야 합니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsJa: [
      ...
      '教師・学生専用エリア',
      '一部コースは SkillsFuture で受講可能',
    ],
    highlightsKo: [
      'AI4I / AI4K 시리즈',
      'OpenAI Academy 등 파트너 리소스',
      '교사 및 학생 전용 공간',
      '일부 과정 SkillsFuture 이용 가능',
    ],
    status: '持续开放',
    statusKo: '지속적 개방',
    statusJa: '継続開放',
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            'AIAP / LADP の前置学習プールとして適しています。',
            '非エンジニアリング層をカバーしています。',
            '学校と教師のためのリソース入口でもあります。',
          ],
          bulletsKo: [
            'AIAP / LADP의 사전 학습 풀로서 적합합니다',
            '비공학 인구를 포함합니다',
            '학교와 교사 자원의 진입점이기도 합니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsJa: [
      ...
      '企業・機構トラック',
      'メンターとワークショップ',
      '優勝チームは賞品またはインターンシップの機会を獲得できます',
    ],
    highlightsKo: ['실제 문제 진술', '기업 및 기관 트랙 주관', '멘토 및 워크숍', '우승팀에게 상 또는 인턴십 기회 제공'],
    status: '2026 决赛阶段',
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            'トラック枠は限定で、先着順です。',
            '登録条件はトラックによって異なります。',
            '一部のトラックはインターンシップの機会または現金賞品を提供しています。',
          ],
          bulletsKo: [
            '트랙의 쿼터는 제한되어 있으며 선착순입니다',
            '등록 조건은 트랙에 따라 다릅니다',
            '일부 트랙은 인턴십 기회 또는 상금을 제공합니다',
          ],
        },
        {
          title: '观察',
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            '予選は決勝に進む上位 150 名をスクリーニングするために使用されます。',
            '決勝後、約 50～60 名の学生がさらなるトレーニングに進みます。',
            '最終的に、8 名の学生がシンガポールを代表して IOAI に参加します。',
          ],
          bulletsKo: [
            '예선은 결승진출 상위 150명을 선별하는 데 사용됩니다',
            '결승 후 약 50-60명의 학생이 추가 훈련에 들어갑니다',
            '최종적으로 8명의 학생이 싱가포르를 대표하여 IOAI에 참가합니다',
          ],
        },
        {
          title: '观察',
  ...
  },
  {
    ...
    highlightsKo: ['AI Singapore Goes To School', 'AI4K 어린이 교육', '교사 AI 소양 향상', '공립학교 AI 교육 자원'],
    status: '持续推进',
    statusKo: '지속적 추진',
    statusJa: '継続推進',
    statusEn: 'Ongoing',
    ...
    profile: {
      ...
      sections: [
        ...
        },
        {
          ...
          bulletsJa: [
            '学校への大量リーチに適しています。',
            '教師トレーニングが教室拡散の能力を決定します。',
            'NAISC / NOAI と学生ファネルを形成します。',
          ],
          bulletsKo: [
            '학교 단위의 대량 도달에 적합합니다',
            '교사 훈련이 교실 확산 능력을 결정합니다',
            'NAISC / NOAI과 함께 학생 펀넬을 형성합니다',
          ],
        },
        {
          title: '观察',
