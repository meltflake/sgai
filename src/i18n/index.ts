...
export const zh = {
  ...
  updatesEmpty: '最近暂无更新。',
  updatesCount: '{n} 条',
  updatesSinceLastVisit: '上次访问后新增 {n} 条',
  mastheadDelta7d: '过去 7 天新增',
  mastheadAsOf: '截至',
  evtDateSitting: '国会',
  evtDatePublished: '发布',
  evtDateAnnounced: '宣布',
  whyItMattersHeading: '为什么重要',
  reportErrorLink: '报告错误',
  markdownExportLink: 'Markdown 版',
...
export const en: Partial<Record<keyof typeof zh, string>> = {
  ...
  navData: 'Data',
  navAnnualReport: 'Annual Report 2026',
  navAbout: 'About',
  ...
  trackerAsOf: 'Data as of {date}',
  citeTitle: 'Cite this record',
  citeSuggested: 'Suggested citation',
  ...
  updatesCount: '{n} items',
  updatesSinceLastVisit: 'New since your last visit: {n}',
  mastheadDelta7d: 'Past 7 days',
  mastheadAsOf: 'as of',
  evtDateSitting: 'Sitting',
  evtDatePublished: 'Published',
  evtDateAnnounced: 'Announced',
  whyItMattersHeading: 'Why it matters',
  reportErrorLink: 'Report an error',
  markdownExportLink: 'Markdown',
  ...
  topicRecentHeading: 'Recent activity',
...
export const ja: Partial<Record<keyof typeof zh, string>> = {
  ...
  trackerAsOf: '{date} 時点のデータ',
  citeTitle: 'この記録を引用',
  citeSuggested: '推奨引用形式',
  citeRetrieved: '取得日',
  citeCopy: 'コピー',
  citeCopied: 'コピーしました',
  ...
  updatesCount: '{n} 件',
  updatesSinceLastVisit: '前回の訪問以降 {n} 件追加',
  mastheadDelta7d: '過去 7 日間の追加',
  mastheadAsOf: '基準日',
  evtDateSitting: '議会',
  evtDatePublished: '公開',
  evtDateAnnounced: '発表',
  whyItMattersHeading: 'なぜ重要か',
  reportErrorLink: '誤りを報告',
  markdownExportLink: 'Markdown 版',
...
export const ko: Partial<Record<keyof typeof zh, string>> = {
  ...
  updatesCount: '{n}건',
  updatesSinceLastVisit: '지난 방문 이후 {n}건 추가',
  mastheadDelta7d: '최근 7일 추가',
  mastheadAsOf: '기준',
  evtDateSitting: '국회',
  evtDatePublished: '발표',
  evtDateAnnounced: '발표',
  whyItMattersHeading: '왜 중요한가',
  reportErrorLink: '오류 신고',
  markdownExportLink: 'Markdown 버전',
