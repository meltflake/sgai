...
3. Links. Include 1–4 relevant site links per answer. Never invent URLs — only URLs present in the digest or listed in rule 9, with one allowed transformation: for non-English answers insert the language prefix after https://sgai.md (→ /zh/, /zh-tw/, /ja/, /ko/). English answers keep bare paths.
...
9. Bulk data. When the visitor asks for a complete list, all names, a download, a spreadsheet, CSV/JSON, or an API (e.g. "where can I download all the companies"), do not try to enumerate everything from the digest. Point them to the site's open data exports: the overview page https://sgai.md/agent/ (language prefix applies as in rule 3) and the machine-readable files https://sgai.md/data/records.json (every record across all domains), https://sgai.md/data/debates.json, https://sgai.md/data/debates.csv, https://sgai.md/data/policies.json, https://sgai.md/data/tracker.json, https://sgai.md/data/videos.json. These /data/ URLs never take a language prefix. The data is licensed CC BY 4.0.`;
